...
Z([3,'classifyitem'])
<<<<<<< HEAD
Z([3,'bg-img bg-mask flex align-center addwh'])
Z([3,'background-image:url(\x27https://ossweb-img.qq.com/images/lol/web201310/skin/big10006.jpg\x27);'])
Z([3,' text-white'])
Z([3,' text-xxl text-alignss'])
Z([3,'钢铁之翼'])
=======
Z([3,'bg-img bg-mask flex align-center cli'])
Z([[2,'+'],[[2,'+'],[1,'background:'],[[2,'+'],[[2,'+'],[1,'url('],[[7],[3,'imgurl']]],[1,')']]],[1,';']])
Z([3,' text-white'])
Z([3,' text-xxl'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[7],[3,'clyname']]],[1,'']]])
>>>>>>> master
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'cu-list menu-avatar comment solids-top comment-bgc'])
Z([3,'cu-item'])
Z([3,'cu-avatar round head-img'])
Z([3,'background-image:url(https://ossweb-img.qq.com/images/lol/img/champion/Morgana.png);'])
Z([3,'content'])
Z([3,'text-grey'])
Z([3,'莫甘娜'])
Z([3,' flex justify-between'])
Z([3,'text-gray text-df date-text'])
Z([3,'2018年12月4日'])
Z([3,'cuIcon-forwardfill margin-sm text-gray'])
Z([3,'cuIcon-appreciatefill text-gray'])
Z([3,'text-co text-content text-df'])
Z([3,'凯尔，你被自己的光芒变的盲目。凯尔，你被自己的光芒变的盲目。凯尔，你被自己的光芒变的盲目。'])
Z([3,' padding-sm radius margin-top-sm  text-sm reapet-box'])
Z([3,'凯尔'])
Z([3,'flex-sub'])
Z([3,'妹妹，你在帮他们给黑暗找借口吗?凯尔，你被自己的光芒变的盲目。凯尔，你被自己的光芒变的盲目。'])
...
Z([3,'__e'])
Z([3,'daysign'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handelDaySign']],[[4],[[5],[1,'$event']]]]]]]]]]])
<<<<<<< HEAD
Z([[6],[[7],[3,'data']],[3,'imgurl']])
=======
>>>>>>> master
Z([3,'../../static/image/daysign.jpg'])
>>>>>>> origin
Z([3,'ds_day'])
Z([3,'24'])
Z([3,'ds_day_time'])
...
Z([3,'author'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[6],[[7],[3,'data']],[3,'author']]],[1,'']]])
...
Z([3,'author'])
Z([3,'title'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[6],[[7],[3,'authordata']],[3,'title']]],[1,'']]])
Z([3,'cu-item'])
Z([3,'cu-avatar round head-img'])
Z([[2,'+'],[[2,'+'],[1,'background:'],[[2,'+'],[[2,'+'],[1,'url('],[[6],[[7],[3,'authordata']],[3,'imgurl']]],[1,')']]],[1,';']])
Z([3,'content'])
Z([3,'text-grey a-name'])
Z([a,[[7],[3,'authorname']]])
Z([3,' flex justify-between'])
Z([3,'text-gray text-df date-text'])
Z([3,'2018年12月4日'])
Z([3,'notice noticecheck'])
Z([3,'关注'])
Z([3,'a-img shadow'])
Z([[6],[[7],[3,'authordata']],[3,'imgurl']])
Z([3,'a-dis'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[6],[[7],[3,'authordata']],[3,'dis']]],[1,'']]])
...
Z(z[3])
Z([3,'的支付给发个简历Joe交通'])
Z([3,'looknum text-right'])
Z([3,'cuIcon-attentionfill look-attentionfill'])
Z([3,'look-num'])
Z([3,'3830'])
...
Z([3,'foucse'])
Z([3,'fc-content'])
Z([3,'cu-avatar round head-img1'])
Z([3,'background-image:url(https://ossweb-img.qq.com/images/lol/img/champion/Morgana.png);'])
Z([3,'text-grey a-name1'])
Z([3,'莫甘娜'])
Z([3,'nownotice'])
Z([3,'正在关注'])
...
Z([3,'关注'])
Z([3,'a-img shadow'])
Z([3,'https://ossweb-img.qq.com/images/lol/img/champion/Morgana.png'])
Z([3,'a-dis'])
Z([3,'你可降低I哦哦佛SNF解耦经济偶在家吃建瓯盘进场来自建瓯市到家了理论基础咯啊好很多了来哦真的很懒\n			理论基础咯啊好很多了来哦真的很懒'])
})(__WXML_GLOBAL__.ops_cached.$gwx_4);return __WXML_GLOBAL__.ops_cached.$gwx_4
}
function gz$gwx_5(){
if( __WXML_GLOBAL__.ops_cached.$gwx_5)return __WXML_GLOBAL__.ops_cached.$gwx_5
...
Z(z[4])
Z(z[5])
Z([3,'那就好说次说错扩耨逛解耦逛监控录像错做那就好说次说错扩耨逛解耦逛监控录像错做做做做做做做做做做做做子扩女扩你看你看今年才可能你可垃圾就是'])
Z(z[3])
Z(z[4])
Z(z[5])
Z([3,'几乎窒息智商低回电话'])
...
Z(z[3])
Z([3,'_img'])
Z([3,'https://ossweb-img.qq.com/images/lol/web201310/skin/big21016.jpg'])
Z([3,'max-width:100%;'])
Z(z[4])
Z(z[5])
Z([3,'_br'])
...
Z([3,'login-content'])
Z([3,'My-login'])
Z([3,'../../static/image/login_03.jpg'])
Z([3,'login-title'])
Z([3,'登录后进行其他操作'])
Z([3,'navigator-hover'])
Z([3,'../login/login'])
Z([3,'cu-btn round lg  bg-black btn-addpd shadow my-btns'])
Z([3,'登录'])
<<<<<<< HEAD
})(__WXML_GLOBAL__.ops_cached.$gwx_8);return __WXML_GLOBAL__.ops_cached.$gwx_8
}
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'bg-gray'])
Z([3,'my_imgbg bg-mask'])
Z([3,'aspectFill'])
Z([3,'../../static/image/userbgimg.jpg'])
Z([3,'usertitle'])
Z([3,'user-icon flex align-center'])
Z([3,'../../static/image/usericon.jpg'])
Z([3,'user-name'])
Z([3,'钢铁侠'])
Z([3,'user-weite flex margin-top-xl'])
Z([3,'my_wr'])
Z([3,'这个人很懒还有没签名'])
Z([3,'text-gray cuIcon-writefill my_wr_icon'])
Z([3,'howread margin-top-xl text-white text-sm'])
Z([3,'已读一篇文章'])
Z([3,'my_list margin-top-sm'])
Z([3,'my_list1'])
...
Z(z[21])
Z([3,'我的投稿'])
Z([3,'cu-bar bg-white margin-top padding flex flex-direction'])
Z([3,'__e'])
Z([3,'cu-btn bg-black  lg text-white shadow'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'padding'])
Z([3,'topic-topbar flex'])
Z([3,'text-black text-bold text-xxl '])
Z([3,'话题'])
Z([3,'__e'])
Z([3,'text-blue'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handelmtopic']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'更多'])
Z([3,'cuIcon-new text-gray text-sl padding-top padding-bottom'])
Z([3,'items text-black text-xxl'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[6],[[7],[3,'topiclist']],[3,'name']]],[1,'']]])
Z([3,'my_talk text-gray padding-top-sm'])
Z([3,'84个讨论'])
...
Z([3,'text'])
Z([3,'pos-msg'])
Z([3,'cuIcon-message po-icon'])
Z([3,'1'])
Z([3,'cuIcon-like po-icon'])
...
Z([3,'__e'])
Z([3,'cu-item shadow'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handelClick']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'image my_add_boder'])
Z([3,'widthFix'])
Z([[6],[[7],[3,'detaildata']],[3,'imgurl']])
Z([3,'my_pos cuIcon-like text-white text-bold text-xl'])
Z([3,'cu-list menu-avatar'])
Z([3,'text-black text-left padding-sm text-lg text-bold text-cut'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[6],[[7],[3,'detaildata']],[3,'title']]],[1,'']]])
Z([3,' flex padding-sm'])
Z([3,'flex-sub flex names'])
Z([3,'text-grey'])
Z([a,[[2,'+'],[[2,'+'],[[6],[[7],[3,'detaildata']],[3,'authorname']],[1,' ']],[[6],[[7],[3,'detaildata']],[3,'clyname']]]])
...
Z([3,'background-image:url(\x27https://ossweb-img.qq.com/images/lol/web201310/skin/big10006.jpg\x27);'])
Z([3,' text-white'])
Z([3,' text-xxl title-text'])
Z([3,'《飞地》从刊'])
Z([3,' text-lg dis-text'])
Z([3,'《飞地》从刊创办于2012年春季，以选题策划的方式专辑出版，致力于当代新诗的深度观察以选题策划的方式专辑出版，致力于当代新诗的深度观察'])
...
Z([3,'d-content'])
Z([3,'bg-white'])
Z([[6],[[7],[3,'detaildata']],[3,'authorname']])
Z([3,'__l'])
Z([3,'1'])
Z(z[6])
Z([[6],[[7],[3,'detaildata']],[3,'content']])
Z([[6],[[7],[3,'detaildata']],[3,'title']])
Z([3,'2'])
Z(z[6])
Z([[6],[[7],[3,'detaildata']],[3,'textfoot']])
>>>>>>> master
Z([3,'3'])
Z(z[6])
Z([3,'4'])
...
>>>>>>> master
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'creater-content padding'])
Z([3,'content-left'])
Z([3,'content-title'])
Z([3,'糖诗'])
Z([3,'content-write'])
Z([3,'“烹羊宰牛且为乐 会须一饮三百杯” 开始琢磨起，诗要几分甜'])
Z([3,'coontent-userinfo'])
Z([3,'user-icon'])
Z([3,'widthFix'])
Z([3,'../../static/image/fz_logo_03.jpg'])
Z([3,'content-info-two'])
Z([3,'userinfo-name'])
Z([3,'西蓝'])
Z([3,'userinfo-daytime'])
Z([3,'07月27日'])
Z([3,'content-right'])
Z(z[8])
Z([3,'../../static/image/suger_03.jpg'])
Z(z[0])
Z(z[1])
Z(z[2])
Z(z[3])
...
Z([3,'index'])
Z([3,'item'])
Z([[6],[[7],[3,'data1']],[3,'content']])
Z(z[13])
Z([3,'my_content'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[7],[3,'item']]],[1,'']]])
Z([3,'author'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[6],[[7],[3,'data1']],[3,'author']]],[1,'']]])
})(__WXML_GLOBAL__.ops_cached.$gwx_19);return __WXML_GLOBAL__.ops_cached.$gwx_19
}
>>>>>>> master
function gz$gwx_20(){
...
<<<<<<< HEAD
Z([3,'preventCollapse'])
Z([3,'uni-slidingMenu solid-bottom addSD  '])
=======
Z([3,'uni-slidingMenu solid-bottom '])
>>>>>>> master
Z([3,'index'])
Z([3,'item'])
Z([[7],[3,'list']])
Z(z[2])
Z([3,'__e'])
Z([[4],[[5],[[5],[[5],[1,'fontSizeSet ']],[1,'slidingMenuList']],[[2,'?:'],[[2,'=='],[[7],[3,'activeIndex']],[[7],[3,'index']]],[1,'active'],[1,'']]]])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'getActive']],[[4],[[5],[[7],[3,'index']]]]]]]]]]]])
Z([a,[[7],[3,'item']]])
Z([3,'index-content '])
Z(z[6])
Z([[7],[3,'activeIndex']])
Z([[4],[[5],[[4],[[5],[[5],[1,'change']],[[4],[[5],[[4],[[5],[[5],[1,'handelSlide']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[2,'+'],[[2,'+'],[1,'height:'],[[2,'+'],[[7],[3,'swiperHeight']],[1,'px']]],[1,';']])
<<<<<<< HEAD
Z([3,'swiper-item  list'])
Z([3,'content'])
Z([3,'text-area padding-top shadow-blur'])
=======
Z([3,'swiper-item list'])
Z([3,'content'])
Z([3,'text-area ta'])
...
Z([3,'1'])
Z(z[5])
Z([3,'more-daysign cuIcon-calendar'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handelMoreDaySign']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'item-list'])
<<<<<<< HEAD
Z(z[18])
Z([3,'2'])
...
Z(z[6])
Z([3,'look-more'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handelMoreTopic']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'更多'])
Z(z[6])
Z(z[31])
Z([[4],[[5],[[5],[1,'card-swiper square-dot']],[[2,'?:'],[[7],[3,'dotStyle']],[1,'square-dot'],[1,'round-dot']]]])
=======
Z(z[5])
Z([3,'look-more'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handelMoreTopic']],[[4],[[5],[1,'$event']]]]]]]]]]])
...
Z([3,'__l'])
Z([3,'__e'])
Z([[4],[[5],[[4],[[5],[[5],[1,'^input']],[[4],[[5],[[4],[[5],[[5],[1,'__set_model']],[[4],[[5],[[5],[[5],[[5],[1,'']],[1,'nameData']],[1,'$event']],[[4],[[5]]]]]]]]]]]]])
Z([3,'11'])
Z([3,'用户名'])
Z([3,'text'])
Z([[7],[3,'nameData']])
...
<<<<<<< HEAD
Z([3,'vue-ref'])
Z([[4],[[5],[[4],[[5],[[5],[1,'^input']],[[4],[[5],[[4],[[5],[[5],[1,'__set_model']],[[4],[[5],[[5],[[5],[[5],[1,'']],[1,'ConfirmData']],[1,'$event']],[[4],[[5]]]]]]]]]]]]])
Z([3,'runCode'])
Z(z[16])
Z([3,'请再次输入密码'])
Z(z[18])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'mores'])
Z([3,'more-logo margin-top-xl'])
Z([3,'../../static/image/logo_03.jpg'])
Z([3,'banben text-gray margin'])
Z([3,'2.2.0'])
Z([3,' text-black margin-top-xl margin-bottom-xl'])
Z([3,'© Copyright 2016-2017 All Rights Reserved'])
Z([3,'text-black '])
Z([3,'鸣谢'])
Z([3,' text-black'])
Z([3,'margin-top'])
...
__WXML_GLOBAL__.ops_cached.$gwx_28=[];
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'bg-white nav text-center my-nav text-pink'])
Z([3,'cu-item fl'])
Z([3,'cuIcon-notice'])
Z([3,'fr'])
Z(z[3])
...
Z([3,'-1'])
Z([3,'请输入想反馈的信息'])
Z([3,'sendemailbtn bg-black addmymargin'])
Z([3,'submit'])
Z([3,'提交'])
<<<<<<< HEAD
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'userinfocontent'])
Z([3,'FreeLandapp用户协议\n	\n	重要须知\n	\n	    「FreeLand」是一款文艺阅读应用app软件，由深圳市FreeLand网络科技有限公司（下称FreeLand网络）开发监制。FreeLand在此特别提醒用户认真阅读、充分理解本《FreeLandapp用户协议》（下称《协议》）──用户应认真阅读、充分理解本《协议》中各条款，包括免除或者限制FreeLand责任的免责条款，以及对用户的权利限制条款。请您审慎阅读后，选择接受或不接受本《协议》（未成年人应在法定监护人陪同下阅读）。除非您接受本《协议》所有条款，否则您无权下载、安装或使用本软件及其相关服务。您的下载、安装、使用、帐号获取和登录等行为将被视为对本《协议》的接受，并表示您同意受本《协议》各项条款的约束。\n	\n	    本《协议》是您（下称「用户」）与深圳市FreeLand网络科技有限公司及其运营合作单位（下称「合作单位」）之间关于用户下载、安装、使用、复制FreeLand出品的阅读软件「FreeLand」（包括但不限于移动电话、平板电脑（tablet）等各种无线手持终端版本等，下称「软件」）；注册、使用、管理FreeLand帐号；以及使用FreeLand网络相关服务所订立的协议。本《协议》描述FreeLand与用户之间关于「软件」许可使用及服务相关方面的权利义务。「用户」是指，通过FreeLand提供的获取软件授权和帐号注册的途径获得软件产品及授权许可，以及使用FreeLand网络相关服务的个人或组织。\n	\n	本《协议》可由FreeLand随时更新，更新后的协议条款一旦公布即代替原来的协议条款，恕不另行通知。用户可重新下载安装本软件或移步FreeLand网站查阅最新版协议条款。在FreeLand修改《协议》条款后，若用户不接受修改后的条款，请立即停止使用FreeLand提供的软件和服务，用户继续使用FreeLand提供的软件和服务将被视为已接受了修改后的协议。\n	\n	一、总则\n	\n	1. FreeLand网络出品的阅读软件「FreeLand」及其提供的服务（以下简称「本软件及服务」）是FreeLand提供的安装在包括但不限于移动电话、平板电脑等各种无线手持终端上的具有网络在线或离线状态下阅读功能的软件及服务。\n	\n	2、用户，包含注册用户和非注册用户。注册用户是指通过FreeLand移动端APP完成全部注册程序后，使用FreeLandapp平台服务的用户。非注册用户是指未进行注册、直接登录FreeLand移动端app使用FreeLandapp平台服务的用户。\n	\n	3、FreeLand阅读软件及服务的所有权和运营权，以及业务规则及活动的解释权均归FreeLand网络所有。\n	\n	4. 若有违反本条款之规定，FreeLand网络有权不经通知终止相关服务。\n	\n	二、关于服务内容 \n	\n	（1）FreeLandapp是为互联网用户提供内容服务的应用软件，包含免费的以及未来可能存在的付费服务，用户通过使用FreeLandapp软件可以轻松的获取文艺作品。FreeLand是一个汇聚当下优秀创作者平台，每日推出数条内容，诗歌、文学、艺术，以视频、声音、文本等形式，带给读者体验。\n	\n	（2）FreeLandapp服务的具体内容由FreeLand网络根据实际情况提供，例如论坛(BBS)、聊天室、电子邮件、发表个人评论等。保留随时变更、中断或终止部分或全部网络服务的权利。       \n	\n	（3）用户应使用正版软件接受网络服务。\n	\n	三、注册\n	\n	一）有关注册资料    \n	\n	 1、提供个人注册资料     \n	\n	（1）在申请FreeLand会员账号时，您向我们提供的是及时、详细及准确的个人资料；     \n	\n	（2）所有由您提供的个人资料将被我们用来作为识别您和其他用户的依据；     \n	\n	（3）如果您所提供的个人注册资料与事实不符，或已变更而未及时更新，或有任何误导之嫌，导致我们无法为您提供或进一步提供产品和服务，我们将不承担任何责任。     \n	\n	2.修改注册资料    \n	\n	您可以在任何时候，通过我们官方网站提供的会员服务或我们公布的其他途径，更新或修改您申请注册时所提供的资料。     \n	\n	3.个人资料的披露     \n	\n	为了向您提供产品和服务，您同意授权我们以我们认为适当的方式向第三方透露您的注册资料。但是，我们不会公开您的姓名、住址、通讯地址、电子邮箱、账号、密码等个人资料。除非：\n	\n	（1）您允许我们披露这些个人资料； （2）有关法律法规或行政规章要求我们披露您的个人资料；\n	\n	（3）司法机关或行政机关基于法定程序要求我们披露您的个人资料；\n	\n	（4）为保护我们的知识产权和其他财产权益，需要披露您的个人资料；\n	\n	（5）在紧急情况下为保护其他用户和社会大众的人身安全，需要披露您的个人资料。     \n	\n	我们将采取商业上合理的方式以保护您的个人资料的安全。我们将使用通常可以获得的安全技术和程序来保护您的个人资料不被未经授权的访问、使用或泄漏。对于非因我们的疏忽而造成您账号的丢失或您个人资料的泄密，我们不承担任何责任。\n	\n	二）关于账号和密码     \n	\n	此处指的是您注册成功的账号及密码。请了解账号在注册之后不可变更，而密码可以通过我们提供的服务进行修改。您对于您的账号及密码的保管以及使用该账号和密码所进行的一切行动负有完全的责任。请不要将账号、密码转让或出借给他人使用。因为您的保管疏忽或其他任何个人行为导致您的账号或密码遭他人非法使用及因此所衍生的任何后果，我们不承担任何责任。\n	\n	四、知识产权声明\n	\n	1.「FreeLand」是由FreeLand网络开发的阅读软件。「FreeLand」APP所载内容版权属于FreeLand网络所有或者经版权人授权FreeLand使用，受各国版权法及国际版权公约的保护。一切著作权、商标权、专利权等知识产权和商业秘密，以及与「FreeLand」相关的所有信息内容，包括但不限于：文字表述（中、英文）及其组合、图标、图饰、图表、色彩、界面设计、版面框架、有关数据、印刷材料、或电子文档等均受中华人民共和国著作权法、商标法、专利法、反不正当竞争法和相应的国际条约以及其他知识产权法律法规的保护，除涉及第三方授权的软件或技术外，FreeLand网络享有上述知识产权。任何个人未经FreeLand网络及其他版权人的书面授权不得转载、链接、转帖或以其他方式复制发布、发表本网站内的内容。\n	\n	2. 未经FreeLand网络及其他版权人书面同意，用户不得为任何营利性或非营利性的目的自行实施、利用、转让或许可任何三方实施、利用、转让上述知识产权，FreeLand保留追究上述未经许可行为的权利。\n	\n	3. 未经FreeLand网络书面同意，用户不得对「FreeLand」进行反向工程（reverse engineer）、反向编译（decompile）或反汇编（disassemble），FreeLand保留追究上述未经许可行为的权利。\n	\n	五、授权范围\n	\n	1. 用户可以为非商业目的设备上安装、使用、显示、运行本「软件」。用户不得为商业运营目的安装、使用、运行本「软件」，不可以对该软件或者该软件运行过程中释放到任何无线手持终端内存中的数据及该软件运行过程中客户端与服务器端的交互数据进行复制、更改、修改、挂接运行或创作任何衍生作品，形式包括但不限于使用插件、外挂或非经授权的第三方工具/服务接入本「软件」和相关系统。\n	\n	2. 保留权利：未明示授权的其他一切权利仍归FreeLand所有，用户使用其他权利时须另外取得FreeLand的书面同意。 	\n	\n	六、使用须知\n	\n	1. 用户必须自行配备手机等无线手持终端上网和使用电信增值业务所需的设备，自行负担个人手机等无线手持终端上网或第三方（包括但不限于电信或移动通信提供商）收取的通讯费、信息费等有关费用。如涉及电信增值服务的，我们建议您与您的电信增值服务提供商确认相关的费用问题。\n	\n	2. 您了解并且同意只要您使用本软件及服务，您将遵守本条款中的权利义务。您对所有在您的注册名下发生的一切行为负责；\n	\n	3. 您了解并且同意FreeLand网络不能为用户行为负责。使用本软件及服务产生的所有风险由您个人承担，FreeLand网络不对本软件及服务的适用性、合法性、安全性、无毒性做任何形式的保证。如果您发现本软件及服务中存在任何违法违规行为，有义务及时向FreeLand网络举报。\n	\n	4. 用户不得利用本软件及服务进行故意制作、传播计算机病毒等破坏性程序，不得针对本服务、与本软件及服务连接的服务器或网络制造干扰、混乱，或违反连接本软件及服务的网络的任何要求、程序、政策或规则，否则FreeLand网络将保留追究其法律责任的权利并有权将其提交给相关部门处理。\n	\n	5. 用户依本协议条款所取得的服务权利不可转让。\n	\n	6. 如用户违反国家法律法规或本协议条款，本公司和合作公司将有权停止向用户提供服务而不需承担任何责任。如导致FreeLand或其合作公司遭受任何损害或遭受任何来自第三方的纠纷、诉讼、索赔要求等，用户须向本公司或合作公司赔偿相应的损失，用户并需对其违反服务条款所产生的一切后果负全部法律责任。\n	\n	7. FreeLand网络保留在任何时候因为任何原因拒绝向任何人提供服务的权利。\n	\n	8、用户授权FreeLand网络进行以下事宜：\n	\n	（1）免费将用户发表的内容整合到FreeLandapp供其他用户浏览，除非有其他书面协议；\n	\n	（2）编辑用户发表的内容，使得它合适整合到FreeLandapp；\n	\n	（3）禁用、禁言违反使用协议的用户；\n	\n	（4）用户涉嫌违法犯罪时，保存用户使用记录跟有关部门上报。\n	\n	9. 用户须遵守包括但不限于以下严禁事宜：\n	\n	（1）利用本软件及服务传播反对宪法所确定的基本原则的内容；\n	\n	（2）利用本软件及服务传播危害国家安全，泄露国家秘密，颠覆国家政权，破（3）坏国家统一的内容；\n	\n	（4）利用本软件及服务传播损害国家荣誉和利益的内容；\n	\n	（5）利用本软件及服务传播煽动民族仇恨、民族歧视，破坏民族团结的内容；\n	\n	（6）利用本软件及服务传播破坏国家宗教政策，宣扬邪教和封建迷信的内容；\n	\n	（7）利用本软件及服务散布谣言，扰乱社会秩序，破坏社会稳定的内容；\n	\n	（8）利用本软件及服务散布淫秽、色情、赌博、暴力、凶杀、恐怖或者教唆犯罪的内容；\n	\n	（9）利用本软件及服务传播侮辱或者诽谤他人，侵害他人合法权益的内容；\n	\n	（10）利用本软件及服务传播含有法律、行政法规禁止的其他内容；\n	\n	（11）制作、发布、传播用于窃取FreeLand帐号及他人专属信息、财产、保密信息的软件；在未经FreeLand网络书面明确授权前提下，出售、出租、出借、散布、转移或转授权软件和服务或相关的链接或从使用软件和服务或软件和服务的条款中获利，无论以上使用是否为直接经济或金钱收益；\n	\n	（12）发表、传送、传播、储存侵害他人知识产权、商业秘密权等合法权利的内容，包含病毒、木马、定时炸弹等可能对同城互助系统造成伤害或影响其稳定性的内容制造虚假身份以误导、欺骗他人；\n	\n	（13）传送或散布以其他方式实现传送含有受到知识产权法律保护的图像、相片、软件或其他资料的文件，除非用户拥有或控制着相应的权利或已得到所有必要的认可；\n	\n	（14）使用任何包含有通过侵犯商标、版权、专利、商业机密或任何一方的其他专有权利的方式利用本“软件”获得的图像或相片的资料或信息；\n	\n	其他以任何不合法的方式、为任何不合法的目的、或以任何与本协议不一致的方式使用本软件和FreeLand提供的其他服务。\n	\n	10、您理解并接受：同城互助信息服务平台作为信息发布、服务平台，无法控制每条信息内容的真实性或准确性。您应自行谨慎判断确定相关信息的真实性、合法性和有效性，并自行承担因此产生的责任与损失。\n	11. 如因用户不遵守本条上述任意一款或者几款的规定，FreeLand网络有权在不事先通知用户的情况下将相应的内容删除，或采取终止、完全或部分中止、限制用户帐号的使用功能或停止用户使用本软件或服务；如造成FreeLand网络损失的，FreeLand网络有权要求用户给予相应的赔偿，包括但不限于FreeLand传媒因此被国家机关予以行政处罚，或者被第三方通过诉讼或其他的方式索赔，赔偿范围包括但不限于罚款、赔偿金以及有树文化支付的相应的诉讼费、律师费。\n	\n	七、服务风险及免责声明\n	\n	1. 本软件及服务仅依其当前所呈现的状况提供，本软件及服务涉及到无线互联网及移动通讯等服务，可能会受到各个环节不稳定因素的影响。因此软件及服务存在因上述不可抗力、计算机病毒或黑客攻击、系统不稳定、用户所在位置、用户关机、GSM等移动网络、互联网络、通信线路原因等造成的服务中断或不能满足用户要求的风险。使用本软件及服务的用户须承担以上风险，FreeLand对服务的及时性、安全性、准确性不作担保。\n	\n	2. 如本公司的系统发生故障而影响到本服务的正常运行，本公司承诺在最短时间内与相关单位配合，及时处理进行修复。但用户因此而产生的经济损失，本公司和合作公司不承担责任。此外，FreeLand网络保留不经事先通知为维修保养、升级或其他目的暂停本服务任何部分的权利。\n	\n	3. 用户在使用本软件及服务时，须自行承担如下包括但不限于来自FreeLand网络不可掌控的风险内容：由于无线网络信号不稳定、无线网络带宽小等原因，所引起的登录失败、页面打开速度慢等风险；用户必须选择与所安装手机相匹配的软件版本，否则，由于软件与手机型号不相匹配所导致的任何软件问题、手机问题或损害，均由用户自行承担；用户手机隐私信息在使用本软件及服务时可能产生的信息安全风险；用户在使用本软件访问第三方网站时遇到内容质量及安全问题等，均由用户自行承担。\n	\n	4. FreeLand在此特别提醒：使用本「软件」必须遵守国家有关法律、法规和政策等，维护国家利益，保护国家安全，并遵守本《协议》。对于用户违法或违反本《协议》的使用而引起的一切责任，由用户负全部责任，一概与FreeLand及合作单位无关；导致FreeLand及合作单位损失的，FreeLand及合作单位有权要求用户赔偿，并有权保留相关记录。而且，对于用户违法或违反本《协议》以及违反了利用本软件和FreeLand帐号访问的FreeLand或合作单位的其他服务规定的相关服务条款，FreeLand有权视用户的行为性质，在不事先通知用户的情况下，采取包括但不限于中断使用许可、停止提供服务、限制使用、回收用户FreeLand帐号、法律追究等措施。对利用FreeLand帐号进行违法活动、骚扰、欺骗其他用户等行为，FreeLand有权回收其帐号。由此带来的包括并不限于用户通信中断、用户资料、邮件丢失等损失由用户自行承担。非经FreeLand或FreeLand授权开发并正式发布的其它任何由本「软件」衍生的软件均属非法，下载、安装、使用此类软件，将可能导致不可预知的风险，由此产生的一切法律责任与纠纷一概与FreeLand无关。用户不得轻易下载、安装、使用此类软件，否则，FreeLand有权在不事先通知用户的情况下单方面终止用户帐号的使用资格。用户只能通过FreeLand提供的本「软件」及其他合法通道登录使用FreeLand。用户不得通过其他未经FreeLand授权开发的包括但不限于非法兼容型软件、程序或者其他非FreeLand明示许可的方式，登录使用FreeLand帐号，否则，FreeLand有权在不事先通知用户的情况下单方面终止用户的FreeLand帐号的使用资格。\n	\n	5、FreeLand网络不对因下述任一情况而导致您的任何损害赔偿承担责任，包括但不限于利润、商誉、使用、数据等方面的损失或其它无形损失的损害赔偿 ：\n	\n	（1) 使用或未能使用FreeLandapp平台服务。\n	\n	（2) 第三方未经批准的使用您的账户或更改您的数据。\n	\n	（3) 通过FreeLandapp平台浏览、搜索的信息而产生的费用及损失。\n	\n	（4) 您对FreeLandapp平台服务的误解。\n	\n	（5)用户任何线下行为，任何因为浏览、搜索FreeLandapp平台提供的信息而产生的费用、损失及伤害，由用户自行承担，请您谨慎对待任何线下行为活动。\n	\n	（6) 任何非因FreeLand的原因而引起的与FreeLandapp平台服务有关的其它损失。\n	\n	八、服务及协议条款的变更\n	\n	1、FreeLand有权在必要时修改本协议条款，协议条款一旦发生变动，将会在相关页面上公布修改后的协议条款。如果不同意所改动的内容，用户应主动取消此项服务。如果用户继续使用服务，则视为接受协议条款的变动。\n	\n	2、FreeLand在提供服务时，可能日后对部分服务的用户开始收取一定的费用。如用户拒绝支付该等费用，则不能在收费开始后继续使用相关的服务，FreeLand有权在不事先通知用户的情况下单方面终止相关的服务。FreeLand和合作公司将尽最大努力通过电邮或其他有效方式通知用户有关收费服务的修改或变更。\n	\n	九、争议管辖及适用法律\n	\n	本协议条款之效力和解释均适用中华人民共和国之法律。如协议条款之任何一部分与中华人民共和国法律相抵触，则该部分条款应按法律规定重新解释，部分条款之无效或重新解释不影响其它条款之法律效力。用户和FreeLand一致同意凡因本服务所产生的纠纷双方应协商解决，协商不成任何一方均可向FreeLand网络所在地法院起诉。\n	\n	FreeLand版权所有，保留一切解释权利。'])
...
<<<<<<< HEAD
var x=['./components/ClassifyItem.wxml','./components/CommentItem.wxml','./components/DaySign.wxml','./components/DetailAuthor.wxml','./components/DetailFooter.wxml','./components/ExproreDetail.wxml','./components/ExproreText.wxml','./components/Foucse.wxml','./components/Logins.wxml','./components/MyTopics.wxml','./components/PostComment.wxml','./components/Potery.wxml','./components/TopicItem.wxml','./components/watch-button.wxml','./components/watch-input.wxml','./pages/Detail/Detail.wxml','./pages/clntest/clntest.wxml','./pages/create/create.wxml','./pages/daysign/DaySignDetail.wxml','./pages/daysign/daysign.wxml','./pages/foucse/foucse.wxml','./pages/index/index.wxml','./pages/login/forget.wxml','./pages/login/login.wxml','./pages/login/register.wxml','./pages/moretopic/moretopic.wxml','./pages/moretopic/mtopic.wxml','./pages/my/Aboutus.wxml','./pages/my/Sendemail.wxml','./pages/my/Setting.wxml','./pages/my/Userinfo.wxml','./pages/my/my.wxml'];d_[x[0]]={}
=======
<<<<<<< HEAD
var x=['./components/ClassifyItem.wxml','./components/CommentItem.wxml','./components/DaySign.wxml','./components/DetailAuthor.wxml','./components/DetailFooter.wxml','./components/ExproreDetail.wxml','./components/ExproreText.wxml','./components/Logins.wxml','./components/MyInfo.wxml','./components/MyTopics.wxml','./components/PostComment.wxml','./components/Potery.wxml','./components/TopicItem.wxml','./components/watch-button.wxml','./components/watch-input.wxml','./components/wjx-edit/wjx-edit.wxml','./pages/Detail/Detail.wxml','./pages/clntest/clntest.wxml','./pages/create/create.wxml','./pages/edit/edit.wxml','./pages/foucse/foucse.wxml','./pages/index/index.wxml','./pages/login/forget.wxml','./pages/login/login.wxml','./pages/login/register.wxml','./pages/moretopic/moretopic.wxml','./pages/my/Aboutus.wxml','./pages/my/Goviews.wxml','./pages/my/Sendemail.wxml','./pages/my/Setting.wxml','./pages/my/Userinfo.wxml','./pages/my/my.wxml'];d_[x[0]]={}
=======
var x=['./components/ClassifyItem.wxml','./components/CommentItem.wxml','./components/DaySign.wxml','./components/DetailAuthor.wxml','./components/DetailFooter.wxml','./components/ExproreDetail.wxml','./components/ExproreText.wxml','./components/Foucse.wxml','./components/Logins.wxml','./components/MyTopics.wxml','./components/PostComment.wxml','./components/Potery.wxml','./components/TopicItem.wxml','./components/watch-button.wxml','./components/watch-input.wxml','./pages/Detail/Detail.wxml','./pages/clntest/clntest.wxml','./pages/create/create.wxml','./pages/daysign/DaySignDetail.wxml','./pages/daysign/daysign.wxml','./pages/foucse/foucse.wxml','./pages/index/index.wxml','./pages/login/forget.wxml','./pages/login/login.wxml','./pages/login/register.wxml','./pages/moretopic/moretopic.wxml','./pages/my/Aboutus.wxml','./pages/my/Sendemail.wxml','./pages/my/Setting.wxml','./pages/my/Userinfo.wxml','./pages/my/my.wxml'];d_[x[0]]={}
>>>>>>> master
>>>>>>> origin
...
var oJ=_mz(z,'view',['class',2,'style',1],[],e,s,gg)
_(cI,oJ)
var lK=_n('view')
...
var o4=_mz(z,'image',['mode',-1,'src',1],[],e,s,gg)
_(b3,o4)
var x5=_n('view')
...
var o4=_mz(z,'image',['mode',-1,'src',3],[],e,s,gg)
_(b3,o4)
var x5=_n('view')
...
var cLB=_n('view')
<<<<<<< HEAD
_rz(z,cLB,'class',16,xIB,oHB,gg)
var hMB=_oz(z,17,xIB,oHB,gg)
=======
_rz(z,cLB,'class',18,xIB,oHB,gg)
var hMB=_oz(z,19,xIB,oHB,gg)
>>>>>>> master
_(cLB,hMB)
_(oJB,cLB)
return oJB
...
eFB.wxXCkey=2
<<<<<<< HEAD
_2z(z,14,bGB,e,s,gg,eFB,'item','index','index')
_(b3,tEB)
var oNB=_n('view')
...
var oNC=_mz(z,'detail-author',['bind:__l',1,'vueId',1],[],e,s,gg)
_(bMC,oNC)
var xOC=_mz(z,'exprore-text',['bind:__l',3,'vueId',1],[],e,s,gg)
_(bMC,xOC)
var oPC=_mz(z,'detail-footer',['bind:__l',5,'vueId',1],[],e,s,gg)
_(bMC,oPC)
var fQC=_mz(z,'post-comment',['bind:__l',7,'vueId',1],[],e,s,gg)
_(bMC,fQC)
_(r,bMC)
return r
}
...
var lWC=_mz(z,'label',['class',4,'style',1],[],e,s,gg)
...
var eZC=_mz(z,'label',['class',8,'style',1],[],e,s,gg)
...
var x3C=_mz(z,'label',['class',12,'style',1],[],e,s,gg)
...
var c6C=_mz(z,'label',['class',16,'style',1],[],e,s,gg)
...
var c9C=_mz(z,'label',['class',20,'style',1],[],e,s,gg)
...
var aBD=_mz(z,'label',['class',24,'style',1],[],e,s,gg)
...
var bED=_mz(z,'image',['class',28,'src',1,'style',2],[],e,s,gg)
_(eDD,bED)
var oFD=_mz(z,'label',['class',31,'style',1],[],e,s,gg)
var xGD=_n('view')
...
var fID=_mz(z,'label',['class',35,'style',1],[],e,s,gg)
var cJD=_oz(z,37,e,s,gg)
_(fID,cJD)
_(oHD,fID)
_(hSC,oHD)
var hKD=_n('view')
_rz(z,hKD,'class',38,e,s,gg)
var oLD=_mz(z,'label',['class',39,'style',1],[],e,s,gg)
...
var lOD=_mz(z,'label',['class',43,'style',1],[],e,s,gg)
...
var eRD=_mz(z,'label',['class',47,'style',1],[],e,s,gg)
var bSD=_oz(z,49,e,s,gg)
_(eRD,bSD)
_(tQD,eRD)
_(hSC,tQD)
var oTD=_n('view')
_rz(z,oTD,'class',50,e,s,gg)
var xUD=_mz(z,'image',['class',51,'src',1,'style',2],[],e,s,gg)
_(oTD,xUD)
var oVD=_mz(z,'label',['class',54,'style',1],[],e,s,gg)
var fWD=_n('view')
...
var o2D=_mz(z,'image',['mode',-1,'src',2],[],e,s,gg)
_(c1D,o2D)
_(oZD,c1D)
var l3D=_n('view')
...
_(l3D,a4D)
_(oZD,l3D)
var t5D=_mz(z,'navigator',['hoverClass',5,'url',1],[],e,s,gg)
var e6D=_n('view')
...
var aXC=_mz(z,'view',['class',2,'style',1],[],e,s,gg)
_(lWC,aXC)
var tYC=_n('view')
...
var z=gz$gwx_9()
var o4C=_n('view')
var f5C=_mz(z,'scroll-view',['scrollX',-1,'class',0],[],e,s,gg)
var c6C=_n('view')
...
var c9C=_mz(z,'navigator',['class',4,'hoverClass',1,'url',2],[],e,s,gg)
var o0C=_n('view')
...
_(c9C,o0C)
_(o8C,c9C)
var aBD=_mz(z,'navigator',['class',9,'hoverClass',1,'url',2],[],e,s,gg)
...
var xGD=_mz(z,'image',['mode',-1,'src',18],[],e,s,gg)
_(oFD,xGD)
_(bED,oFD)
var oHD=_n('view')
...
_(oHD,fID)
_(bED,oHD)
var cJD=_mz(z,'navigator',['hoverClass',21,'url',1],[],e,s,gg)
var hKD=_n('view')
...
_(aPD,tQD)
_(lOD,aPD)
var eRD=_mz(z,'text',['bindtap',4,'class',1,'data-event-opts',2],[],e,s,gg)
...
var oZD=_n('view')
_rz(z,oZD,'class',0,e,s,gg)
var c1D=_mz(z,'input',['class',1,'placeholder',1,'placeholderClass',2,'type',3],[],e,s,gg)
_(oZD,c1D)
var o2D=_n('view')
...
<<<<<<< HEAD
var fAE=_mz(z,'image',['mode',2,'src',1],[],e,s,gg)
_(o0D,fAE)
var cBE=_n('view')
_rz(z,cBE,'class',4,e,s,gg)
var hCE=_n('view')
_rz(z,hCE,'class',5,e,s,gg)
var oDE=_mz(z,'image',['mode',-1,'src',6],[],e,s,gg)
_(hCE,oDE)
var cEE=_n('view')
...
var cHF=_mz(z,'button',['bindtap',46,'class',1,'data-event-opts',2,'data-target',3,'style',4],[],e,s,gg)
...
var oTF=_mz(z,'button',['bindtap',64,'class',1,'data-event-opts',2],[],e,s,gg)
var fUF=_oz(z,67,e,s,gg)
_(oTF,fUF)
_(xSF,oTF)
var cVF=_mz(z,'button',['bindtap',68,'class',1,'data-event-opts',2],[],e,s,gg)
var hWF=_oz(z,71,e,s,gg)
_(cVF,hWF)
_(xSF,cVF)
_(oRF,xSF)
_(cKF,oRF)
...
var cYF=_mz(z,'view',['catchtap',75,'class',1,'data-event-opts',2,'style',3],[],e,s,gg)
var oZF=_n('view')
...
var x7F=_n('view')
_rz(z,x7F,'class',84,e4F,t3F,gg)
var o8F=_n('view')
_rz(z,o8F,'class',85,e4F,t3F,gg)
var f9F=_n('view')
var c0F=_oz(z,86,e4F,t3F,gg)
_(f9F,c0F)
_(o8F,f9F)
_(x7F,o8F)
_(b5F,x7F)
...
l1F.wxXCkey=2
_2z(z,82,a2F,e,s,gg,l1F,'item','index','index')
_(cYF,oZF)
_(oXF,cYF)
_(x9D,oXF)
_(r,x9D)
...
var hOG=_mz(z,'input',['class',1,'placeholder',1,'placeholderClass',2,'type',3],[],e,s,gg)
_(cNG,hOG)
var oPG=_n('view')
...
var c5G=_mz(z,'image',['mode',10,'src',1],[],e,s,gg)
_(o4G,c5G)
var o6G=_n('view')
...
var z=gz$gwx_14()
var fSH=_n('view')
var cTH=_mz(z,'button',['class',0,'style',1],[],e,s,gg)
var hUH=_n('view')
...
var x5H=_mz(z,'input',['bindinput',1,'class',1,'data-event-opts',2,'maxlength',3,'password',4,'placeholder',5,'type',6,'value',7],[],e,s,gg)
_(e2H,x5H)
var b3H=_v()
_(e2H,b3H)
if(_oz(z,9,e,s,gg)){b3H.wxVkey=1
var o6H=_mz(z,'image',['bindtap',10,'class',1,'data-event-opts',2],[],e,s,gg)
_(b3H,o6H)
}
var o4H=_v()
_(e2H,o4H)
...
var z=gz$gwx_16()
var o0H=_n('view')
var cAI=_mz(z,'view',['bindtap',0,'class',1,'data-event-opts',1,'hidden',2],[],e,s,gg)
_(o0H,cAI)
var oBI=_mz(z,'view',['class',4,'hidden',1],[],e,s,gg)
var lCI=_n('view')
_rz(z,lCI,'class',6,e,s,gg)
var aDI=_mz(z,'view',['bindtap',7,'class',1,'data-event-opts',2],[],e,s,gg)
_(lCI,aDI)
var tEI=_mz(z,'view',['bindtap',10,'class',1,'data-event-opts',2],[],e,s,gg)
_(lCI,tEI)
var eFI=_mz(z,'view',['bindtap',13,'class',1,'data-event-opts',2],[],e,s,gg)
_(lCI,eFI)
var bGI=_mz(z,'view',['bindtap',16,'class',1,'data-event-opts',2],[],e,s,gg)
_(lCI,bGI)
var oHI=_mz(z,'view',['bindtap',19,'class',1,'data-event-opts',2],[],e,s,gg)
_(lCI,oHI)
var xII=_mz(z,'view',['bindtap',22,'class',1,'data-event-opts',2],[],e,s,gg)
_(lCI,xII)
var oJI=_mz(z,'view',['bindtap',25,'class',1,'data-event-opts',2],[],e,s,gg)
_(lCI,oJI)
var fKI=_mz(z,'view',['bindtap',28,'class',1,'data-event-opts',2],[],e,s,gg)
_(lCI,fKI)
_(oBI,lCI)
var cLI=_n('view')
_rz(z,cLI,'class',31,e,s,gg)
var hMI=_n('view')
_rz(z,hMI,'style',32,e,s,gg)
var oNI=_oz(z,33,e,s,gg)
_(hMI,oNI)
_(cLI,hMI)
var cOI=_mz(z,'textarea',['autoHeight',-1,'bindinput',34,'data-event-opts',1,'maxlength',2,'value',3],[],e,s,gg)
_(cLI,cOI)
_(oBI,cLI)
var oPI=_n('view')
_rz(z,oPI,'style',38,e,s,gg)
var lQI=_n('view')
_rz(z,lQI,'style',39,e,s,gg)
var aRI=_mz(z,'view',['bindtap',40,'data-event-opts',1,'style',2],[],e,s,gg)
var tSI=_oz(z,43,e,s,gg)
_(aRI,tSI)
_(lQI,aRI)
var eTI=_mz(z,'view',['bindtap',44,'data-event-opts',1,'style',2],[],e,s,gg)
var bUI=_oz(z,47,e,s,gg)
_(eTI,bUI)
_(lQI,eTI)
_(oPI,lQI)
_(oBI,oPI)
_(o0H,oBI)
var oVI=_mz(z,'view',['class',48,'hidden',1],[],e,s,gg)
var xWI=_n('view')
_rz(z,xWI,'style',50,e,s,gg)
var oXI=_mz(z,'view',['bindtap',51,'class',1,'data-event-opts',2],[],e,s,gg)
var fYI=_oz(z,54,e,s,gg)
_(oXI,fYI)
_(xWI,oXI)
var cZI=_mz(z,'view',['bindtap',55,'class',1,'data-event-opts',2],[],e,s,gg)
var h1I=_oz(z,58,e,s,gg)
_(cZI,h1I)
_(xWI,cZI)
var o2I=_mz(z,'view',['bindtap',59,'class',1,'data-event-opts',2],[],e,s,gg)
var c3I=_oz(z,62,e,s,gg)
_(o2I,c3I)
_(xWI,o2I)
var o4I=_mz(z,'view',['bindtap',63,'class',1,'data-event-opts',2],[],e,s,gg)
var l5I=_oz(z,66,e,s,gg)
_(o4I,l5I)
_(xWI,o4I)
var a6I=_mz(z,'view',['bindtap',67,'class',1,'data-event-opts',2],[],e,s,gg)
var t7I=_oz(z,70,e,s,gg)
_(a6I,t7I)
_(xWI,a6I)
_(oVI,xWI)
_(o0H,oVI)
var e8I=_n('view')
_rz(z,e8I,'class',71,e,s,gg)
var b9I=_v()
_(e8I,b9I)
if(_oz(z,72,e,s,gg)){b9I.wxVkey=1
var o0I=_mz(z,'view',['bindtap',73,'class',1,'data-event-opts',2],[],e,s,gg)
...
var oHJ=_mz(z,'view',['bindtap',81,'class',1,'data-event-opts',2,'data-ref',3,'style',4],[],hEJ,cDJ,gg)
var lIJ=_v()
_(oHJ,lIJ)
if(_oz(z,86,hEJ,cDJ,gg)){lIJ.wxVkey=1
var eLJ=_n('view')
_rz(z,eLJ,'style',87,hEJ,cDJ,gg)
var bMJ=_oz(z,88,hEJ,cDJ,gg)
_(eLJ,bMJ)
_(lIJ,eLJ)
}
var aJJ=_v()
_(oHJ,aJJ)
if(_oz(z,89,hEJ,cDJ,gg)){aJJ.wxVkey=1
var oNJ=_n('image')
_rz(z,oNJ,'src',90,hEJ,cDJ,gg)
_(aJJ,oNJ)
}
var tKJ=_v()
_(oHJ,tKJ)
if(_oz(z,91,hEJ,cDJ,gg)){tKJ.wxVkey=1
var xOJ=_mz(z,'video',['controls',-1,'src',92],[],hEJ,cDJ,gg)
_(tKJ,xOJ)
}
lIJ.wxXCkey=1
aJJ.wxXCkey=1
...
oBJ.wxXCkey=2
_2z(z,79,fCJ,e,s,gg,oBJ,'item','index','index')
b9I.wxXCkey=1
_(o0H,e8I)
_(r,o0H)
return r
...
var cRJ=_mz(z,'image',['class',1,'src',1],[],e,s,gg)
_(fQJ,cRJ)
var hSJ=_n('view')
...
var oVJ=_mz(z,'detail-author',['bind:__l',6,'vueId',1],[],e,s,gg)
_(cUJ,oVJ)
var lWJ=_mz(z,'exprore-text',['bind:__l',8,'vueId',1],[],e,s,gg)
_(cUJ,lWJ)
var aXJ=_mz(z,'detail-footer',['bind:__l',10,'vueId',1],[],e,s,gg)
_(cUJ,aXJ)
var tYJ=_mz(z,'post-comment',['bind:__l',12,'vueId',1],[],e,s,gg)
_(cUJ,tYJ)
var eZJ=_n('view')
...
var o4J=_mz(z,'comment-item',['bind:__l',18,'vueId',1],[],e,s,gg)
_(x3J,o4J)
_(eZJ,x3J)
_(cUJ,eZJ)
_(fQJ,cUJ)
...
var z=gz$gwx_18()
var c6J=_mz(z,'view',['class',0,'style',1],[],e,s,gg)
var h7J=_mz(z,'classify-item',['bind:__l',2,'vueId',1],[],e,s,gg)
_(c6J,h7J)
var o8J=_mz(z,'topic-item',['bind:__l',4,'vueId',1],[],e,s,gg)
_(c6J,o8J)
var c9J=_mz(z,'comment-item',['bind:__l',6,'vueId',1],[],e,s,gg)
_(c6J,c9J)
var o0J=_mz(z,'exprore-detail',['bind:__l',8,'vueId',1],[],e,s,gg)
_(c6J,o0J)
_(r,c6J)
return r
}
...
var eRK=_mz(z,'image',['mode',16,'src',1],[],e,s,gg)
_(tQK,eRK)
_(tCK,tQK)
_(aBK,tCK)
var bSK=_n('view')
...
var c1K=_mz(z,'image',['mode',26,'src',1],[],e,s,gg)
_(oZK,c1K)
_(hYK,oZK)
var o2K=_n('view')
...
var o8K=_mz(z,'image',['mode',34,'src',1],[],e,s,gg)
_(b7K,o8K)
_(bSK,b7K)
_(aBK,bSK)
var x9K=_n('view')
...
var lGL=_mz(z,'image',['mode',44,'src',1],[],e,s,gg)
_(oFL,lGL)
_(cEL,oFL)
var aHL=_n('view')
...
var oNL=_mz(z,'image',['mode',52,'src',1],[],e,s,gg)
_(xML,oNL)
_(x9K,xML)
_(aBK,x9K)
var fOL=_n('view')
...
var c4L=_mz(z,'image',['mode',70,'src',1],[],e,s,gg)
_(f3L,c4L)
_(fOL,f3L)
_(aBK,fOL)
_(r,aBK)
...
var c7L=_mz(z,'edits',['bind:__l',1,'class',1,'data-ref',2,'paddingBottom',3,'placeText',4,'vueId',5],[],e,s,gg)
=======
...
var lGE=_mz(z,'image',['mode',10,'src',1],[],e,s,gg)
_(oFE,lGE)
var aHE=_n('view')
...
var z=gz$gwx_14()
var h5E=_n('view')
var o6E=_mz(z,'button',['class',0,'style',1],[],e,s,gg)
var c7E=_n('view')
...
var fGF=_mz(z,'input',['bindinput',1,'class',1,'data-event-opts',2,'maxlength',3,'password',4,'placeholder',5,'type',6,'value',7],[],e,s,gg)
_(oDF,fGF)
var xEF=_v()
_(oDF,xEF)
if(_oz(z,9,e,s,gg)){xEF.wxVkey=1
var cHF=_mz(z,'image',['bindtap',10,'class',1,'data-event-opts',2],[],e,s,gg)
_(xEF,cHF)
}
var oFF=_v()
_(oDF,oFF)
if(_oz(z,13,e,s,gg)){oFF.wxVkey=1
var hIF=_mz(z,'view',['bindtap',14,'class',1,'data-event-opts',2],[],e,s,gg)
...
var lMF=_mz(z,'image',['class',1,'src',1],[],e,s,gg)
_(oLF,lMF)
var aNF=_n('view')
...
var ePF=_mz(z,'detail-author',['authorname',5,'bind:__l',1,'vueId',2],[],e,s,gg)
_(tOF,ePF)
var bQF=_mz(z,'exprore-text',['bind:__l',8,'text',1,'title',2,'vueId',3],[],e,s,gg)
_(tOF,bQF)
var oRF=_mz(z,'detail-footer',['bind:__l',12,'foot',1,'vueId',2],[],e,s,gg)
_(tOF,oRF)
var xSF=_mz(z,'post-comment',['bind:__l',15,'vueId',1],[],e,s,gg)
_(tOF,xSF)
var oTF=_n('view')
...
var oXF=_mz(z,'comment-item',['bind:__l',21,'vueId',1],[],e,s,gg)
_(hWF,oXF)
_(oTF,hWF)
_(tOF,oTF)
_(oLF,tOF)
...
var l1F=_mz(z,'classify-item',['bind:__l',2,'vueId',1],[],e,s,gg)
_(oZF,l1F)
var a2F=_mz(z,'topic-item',['bind:__l',4,'vueId',1],[],e,s,gg)
_(oZF,a2F)
var t3F=_mz(z,'comment-item',['bind:__l',6,'vueId',1],[],e,s,gg)
_(oZF,t3F)
var e4F=_mz(z,'exprore-detail',['bind:__l',8,'vueId',1],[],e,s,gg)
_(oZF,e4F)
_(r,oZF)
return r
}
...
var lEG=_mz(z,'image',['mode',8,'src',1],[],e,s,gg)
_(oDG,lEG)
_(cCG,oDG)
var aFG=_n('view')
...
var oLG=_mz(z,'image',['mode',16,'src',1],[],e,s,gg)
_(xKG,oLG)
_(x7F,xKG)
_(o6F,x7F)
var fMG=_n('view')
...
var tUG=_mz(z,'image',['mode',26,'src',1],[],e,s,gg)
_(aTG,tUG)
_(lSG,aTG)
var eVG=_n('view')
...
var c2G=_mz(z,'image',['mode',34,'src',1],[],e,s,gg)
_(f1G,c2G)
_(fMG,f1G)
_(o6F,fMG)
var h3G=_n('view')
...
var bAH=_mz(z,'image',['mode',44,'src',1],[],e,s,gg)
_(e0G,bAH)
_(t9G,e0G)
var oBH=_n('view')
...
var oHH=_mz(z,'image',['mode',52,'src',1],[],e,s,gg)
_(hGH,oHH)
_(h3G,hGH)
_(o6F,h3G)
var cIH=_n('view')
...
var xQH=_mz(z,'image',['mode',62,'src',1],[],e,s,gg)
_(oPH,xQH)
_(bOH,oPH)
var oRH=_n('view')
_rz(z,oRH,'class',64,e,s,gg)
var fSH=_n('view')
...
var oXH=_mz(z,'image',['mode',70,'src',1],[],e,s,gg)
_(cWH,oXH)
_(cIH,cWH)
_(o6F,cIH)
_(r,o6F)
...
var e2H=_mz(z,'image',['mode',-1,'src',2],[],e,s,gg)
_(t1H,e2H)
var b3H=_n('view')
...
var oJI=_n('view')
_rz(z,oJI,'class',17,bGI,eFI,gg)
var fKI=_oz(z,18,bGI,eFI,gg)
_(oJI,fKI)
_(oHI,oJI)
return oHI
}
aDI.wxXCkey=2
_2z(z,15,tEI,e,s,gg,aDI,'item','index','index')
_(aZH,lCI)
var cLI=_n('view')
...
var oVI=_mz(z,'day-sign',['bind:__l',5,'dsitem',1,'vueId',2],[],tSI,aRI,gg)
_(eTI,oVI)
return eTI
}
oPI.wxXCkey=4
...
_(fYI,cZI)
_(oXI,fYI)
var h1I=_mz(z,'focuse',['bind:__l',3,'vueId',1],[],e,s,gg)
_(oXI,h1I)
var o2I=_n('view')
...
var z=gz$gwx_22()
var l5I=_n('view')
var a6I=_mz(z,'scroll-view',['scrollX',-1,'class',0],[],e,s,gg)
var t7I=_v()
_(a6I,t7I)
var e8I=function(o0I,b9I,xAJ,gg){
var fCJ=_mz(z,'view',['bindtap',5,'class',1,'data-event-opts',2],[],o0I,b9I,gg)
var cDJ=_oz(z,8,o0I,b9I,gg)
_(fCJ,cDJ)
_(xAJ,fCJ)
return xAJ
}
...
_(l5I,a6I)
var hEJ=_n('view')
var oFJ=_mz(z,'swiper',['bindchange',9,'current',1,'data-event-opts',2,'style',3],[],e,s,gg)
...
var tKJ=_mz(z,'day-sign',['bind:__l',16,'vueId',1],[],e,s,gg)
_(aJJ,tKJ)
var eLJ=_mz(z,'text',['bindtap',18,'class',1,'data-event-opts',2],[],e,s,gg)
_(aJJ,eLJ)
_(lIJ,aJJ)
var bMJ=_n('view')
...
var oTJ=_mz(z,'potery',['bind:__l',26,'detaildata',1,'vueId',2],[],fQJ,oPJ,gg)
_(cRJ,oTJ)
return cRJ
}
oNJ.wxXCkey=4
...
var oVJ=_mz(z,'topics',['bind:__l',30,'vueId',1],[],e,s,gg)
_(cUJ,oVJ)
_(lIJ,cUJ)
_(oHJ,lIJ)
_(cGJ,oHJ)
...
var x3J=_mz(z,'swiper',['autoplay',37,'circular',1,'class',2,'indicatorDots',3,'interval',4],[],e,s,gg)
...
_(eDK,bEK)
var oFK=_mz(z,'text',['bindtap',51,'class',1,'data-event-opts',2],[],e,s,gg)
var xGK=_oz(z,54,e,s,gg)
_(oFK,xGK)
_(eDK,oFK)
_(tCK,eDK)
var oHK=_mz(z,'swiper',['bindchange',55,'circular',1,'class',2,'data-event-opts',3,'duration',4,'indicatorActiveColor',5,'indicatorColor',6,'interval',7],[],e,s,gg)
var fIK=_v()
_(oHK,fIK)
var cJK=function(oLK,hKK,cMK,gg){
var lOK=_n('swiper-item')
_rz(z,lOK,'class',67,oLK,hKK,gg)
var aPK=_n('view')
_rz(z,aPK,'class',68,oLK,hKK,gg)
var tQK=_v()
_(aPK,tQK)
if(_oz(z,69,oLK,hKK,gg)){tQK.wxVkey=1
var bSK=_mz(z,'image',['class',70,'mode',1,'src',2],[],oLK,hKK,gg)
_(tQK,bSK)
}
var eRK=_v()
_(aPK,eRK)
if(_oz(z,73,oLK,hKK,gg)){eRK.wxVkey=1
var oTK=_mz(z,'video',['autoplay',-1,'loop',-1,'controls',74,'muted',1,'objectFit',2,'showPlayBtn',3,'src',4],[],oLK,hKK,gg)
_(eRK,oTK)
}
var xUK=_n('view')
_rz(z,xUK,'class',79,oLK,hKK,gg)
var oVK=_oz(z,80,oLK,hKK,gg)
_(xUK,oVK)
_(aPK,xUK)
tQK.wxXCkey=1
eRK.wxXCkey=1
...
fIK.wxXCkey=2
_2z(z,65,cJK,e,s,gg,fIK,'item','index','index')
_(tCK,oHK)
_(tYJ,tCK)
var fWK=_n('view')
...
var b7K=_mz(z,'classify-item',['bind:__l',89,'clyname',1,'imgurl',2,'vueId',3],[],a4K,l3K,gg)
_(t5K,b7K)
return t5K
}
c1K.wxXCkey=4
_2z(z,87,o2K,e,s,gg,c1K,'item','index','index')
_(fWK,oZK)
_(tYJ,fWK)
_(aXJ,tYJ)
_(lWJ,aXJ)
...
_(cBL,hCL)
_(fAL,cBL)
var oDL=_mz(z,'w-input',['bind:__l',5,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(fAL,oDL)
var cEL=_mz(z,'w-input',['isShowPass',-1,'bind:__l',13,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(fAL,cEL)
var oFL=_mz(z,'w-input',['isShowCode',-1,'bind:__l',21,'bind:input',1,'bind:setCode',2,'class',3,'codeText',4,'data-event-opts',5,'data-ref',6,'maxlength',7,'placeholder',8,'setTime',9,'type',10,'value',11,'vueId',12],[],e,s,gg)
_(fAL,oFL)
_(o0K,fAL)
var lGL=_mz(z,'w-button',['bind:__l',34,'bindtap',1,'data-event-opts',2,'rotate',3,'text',4,'vueId',5],[],e,s,gg)
_(o0K,lGL)
_(x9K,o0K)
_(r,x9K)
return r
...
var oLL=_n('image')
_rz(z,oLL,'src',3,e,s,gg)
_(bKL,oLL)
_(eJL,bKL)
var xML=_n('view')
_rz(z,xML,'class',4,e,s,gg)
var oNL=_mz(z,'w-input',['bind:__l',5,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(xML,oNL)
var fOL=_mz(z,'w-input',['bind:__l',13,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(xML,fOL)
_(eJL,xML)
var cPL=_mz(z,'w-button',['bind:__l',21,'bindtap',1,'data-event-opts',2,'rotate',3,'text',4,'vueId',5],[],e,s,gg)
_(eJL,cPL)
var hQL=_n('view')
_rz(z,hQL,'class',27,e,s,gg)
var oRL=_mz(z,'navigator',['openType',28,'url',1],[],e,s,gg)
...
_(oTL,lUL)
_(hQL,oTL)
var aVL=_mz(z,'navigator',['openType',32,'url',1],[],e,s,gg)
...
var c4L=_mz(z,'w-input',['bind:__l',5,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(f3L,c4L)
var h5L=_mz(z,'w-input',['isShowPass',-1,'bind:__l',13,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(f3L,h5L)
_(oZL,f3L)
var o6L=_mz(z,'w-button',['bind:__l',21,'bindtap',1,'data-event-opts',2,'rotate',3,'text',4,'vueId',5],[],e,s,gg)
_(oZL,o6L)
var c7L=_n('view')
_rz(z,c7L,'class',27,e,s,gg)
var o8L=_mz(z,'text',['bindtap',28,'class',1,'data-event-opts',2],[],e,s,gg)
var l9L=_oz(z,31,e,s,gg)
_(o8L,l9L)
_(c7L,o8L)
var a0L=_mz(z,'navigator',['url',-1,'openType',32],[],e,s,gg)
...
_(r,bYL)
=======
var bCM=_mz(z,'w-button',['bind:__l',21,'bindtap',1,'data-event-opts',2,'rotate',3,'text',4,'vueId',5],[],e,s,gg)
_(c7L,bCM)
var oDM=_n('view')
_rz(z,oDM,'class',27,e,s,gg)
var xEM=_mz(z,'text',['bindtap',28,'class',1,'data-event-opts',2],[],e,s,gg)
var oFM=_oz(z,31,e,s,gg)
_(xEM,oFM)
_(oDM,xEM)
var fGM=_mz(z,'navigator',['url',-1,'openType',32],[],e,s,gg)
...
var a0L=_mz(z,'editor',['bindready',1,'class',1,'data-event-opts',2,'id',3,'placeholder',4],[],e,s,gg)
_(l9L,a0L)
var tAM=_mz(z,'button',['bindtap',6,'data-event-opts',1,'type',2],[],e,s,gg)
...
_(oDM,xEM)
var oFM=_mz(z,'scroll-view',['scrollX',-1,'class',1],[],e,s,gg)
var fGM=_v()
_(oFM,fGM)
var cHM=function(oJM,hIM,cKM,gg){
var lMM=_mz(z,'view',['bindtap',6,'class',1,'data-event-opts',2],[],oJM,hIM,gg)
var aNM=_oz(z,9,oJM,hIM,gg)
_(lMM,aNM)
_(cKM,lMM)
return cKM
}
...
var ePM=_mz(z,'swiper',['bindchange',11,'current',1,'data-event-opts',2,'style',3],[],e,s,gg)
...
var fUM=_mz(z,'day-sign',['bind:__l',18,'vueId',1],[],e,s,gg)
_(oTM,fUM)
_(xSM,oTM)
var cVM=_n('view')
_rz(z,cVM,'class',20,e,s,gg)
var hWM=_mz(z,'potery',['bind:__l',21,'vueId',1],[],e,s,gg)
_(cVM,hWM)
_(xSM,cVM)
var oXM=_n('view')
_rz(z,oXM,'class',23,e,s,gg)
var cYM=_mz(z,'topics',['bind:__l',24,'vueId',1],[],e,s,gg)
_(oXM,cYM)
_(xSM,oXM)
_(oRM,xSM)
_(bQM,oRM)
...
var o6M=_mz(z,'swiper',['autoplay',31,'circular',1,'class',2,'indicatorDots',3,'interval',4],[],e,s,gg)
...
_(tGN,eHN)
var bIN=_mz(z,'text',['bindtap',45,'class',1,'data-event-opts',2],[],e,s,gg)
var oJN=_oz(z,48,e,s,gg)
_(bIN,oJN)
_(tGN,bIN)
_(aFN,tGN)
var xKN=_mz(z,'swiper',['bindchange',49,'circular',1,'class',2,'data-event-opts',3,'duration',4,'indicatorActiveColor',5,'indicatorColor',6,'interval',7],[],e,s,gg)
var oLN=_v()
_(xKN,oLN)
var fMN=function(hON,cNN,oPN,gg){
var oRN=_n('swiper-item')
_rz(z,oRN,'class',61,hON,cNN,gg)
var lSN=_n('view')
_rz(z,lSN,'class',62,hON,cNN,gg)
var aTN=_v()
_(lSN,aTN)
if(_oz(z,63,hON,cNN,gg)){aTN.wxVkey=1
var eVN=_mz(z,'image',['class',64,'mode',1,'src',2],[],hON,cNN,gg)
_(aTN,eVN)
}
var tUN=_v()
_(lSN,tUN)
if(_oz(z,67,hON,cNN,gg)){tUN.wxVkey=1
var bWN=_mz(z,'video',['autoplay',-1,'loop',-1,'controls',68,'muted',1,'objectFit',2,'showPlayBtn',3,'src',4],[],hON,cNN,gg)
_(tUN,bWN)
}
var oXN=_n('view')
_rz(z,oXN,'class',73,hON,cNN,gg)
var xYN=_oz(z,74,hON,cNN,gg)
_(oXN,xYN)
_(lSN,oXN)
aTN.wxXCkey=1
tUN.wxXCkey=1
...
oLN.wxXCkey=2
_2z(z,59,fMN,e,s,gg,oLN,'item','index','index')
_(aFN,xKN)
_(a2M,aFN)
var oZN=_n('view')
_rz(z,oZN,'class',75,e,s,gg)
var f1N=_n('view')
_rz(z,f1N,'class',76,e,s,gg)
var c2N=_oz(z,77,e,s,gg)
_(f1N,c2N)
_(oZN,f1N)
var h3N=_n('view')
_rz(z,h3N,'class',78,e,s,gg)
var o4N=_mz(z,'classify-item',['bind:__l',79,'vueId',1],[],e,s,gg)
_(h3N,o4N)
var c5N=_mz(z,'classify-item',['bind:__l',81,'vueId',1],[],e,s,gg)
_(h3N,c5N)
var o6N=_mz(z,'classify-item',['bind:__l',83,'vueId',1],[],e,s,gg)
_(h3N,o6N)
var l7N=_mz(z,'classify-item',['bind:__l',85,'vueId',1],[],e,s,gg)
_(h3N,l7N)
var a8N=_mz(z,'classify-item',['bind:__l',87,'vueId',1],[],e,s,gg)
_(h3N,a8N)
_(oZN,h3N)
_(a2M,oZN)
_(l1M,a2M)
...
_(xCO,oDO)
_(oBO,xCO)
var fEO=_mz(z,'w-input',['bind:__l',5,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(oBO,fEO)
var cFO=_mz(z,'w-input',['isShowPass',-1,'bind:__l',13,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(oBO,cFO)
var hGO=_mz(z,'w-input',['isShowCode',-1,'bind:__l',21,'bind:input',1,'bind:setCode',2,'class',3,'codeText',4,'data-event-opts',5,'data-ref',6,'maxlength',7,'placeholder',8,'setTime',9,'type',10,'value',11,'vueId',12],[],e,s,gg)
_(oBO,hGO)
_(bAO,oBO)
var oHO=_mz(z,'w-button',['bind:__l',34,'bindtap',1,'data-event-opts',2,'rotate',3,'text',4,'vueId',5],[],e,s,gg)
_(bAO,oHO)
_(e0N,bAO)
_(r,e0N)
return r
...
var tMO=_n('image')
_rz(z,tMO,'src',3,e,s,gg)
_(aLO,tMO)
_(lKO,aLO)
var eNO=_n('view')
_rz(z,eNO,'class',4,e,s,gg)
var bOO=_mz(z,'w-input',['bind:__l',5,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(eNO,bOO)
var oPO=_mz(z,'w-input',['bind:__l',13,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(eNO,oPO)
_(lKO,eNO)
var xQO=_mz(z,'w-button',['bind:__l',21,'bindtap',1,'data-event-opts',2,'rotate',3,'text',4,'vueId',5],[],e,s,gg)
_(lKO,xQO)
var oRO=_n('view')
_rz(z,oRO,'class',27,e,s,gg)
var fSO=_mz(z,'navigator',['openType',28,'url',1],[],e,s,gg)
...
_(hUO,oVO)
_(oRO,hUO)
var cWO=_mz(z,'navigator',['openType',32,'url',1],[],e,s,gg)
...
var b3O=_n('image')
_rz(z,b3O,'src',3,e,s,gg)
_(e2O,b3O)
_(t1O,e2O)
var o4O=_n('view')
_rz(z,o4O,'class',4,e,s,gg)
var x5O=_mz(z,'w-input',['bind:__l',5,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(o4O,x5O)
var o6O=_mz(z,'w-input',['isShowPass',-1,'bind:__l',13,'bind:input',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(o4O,o6O)
var f7O=_mz(z,'w-input',['isShowPass',-1,'bind:__l',21,'bind:input',1,'class',2,'data-event-opts',3,'data-ref',4,'maxlength',5,'placeholder',6,'type',7,'value',8,'vueId',9],[],e,s,gg)
_(o4O,f7O)
_(t1O,o4O)
var c8O=_mz(z,'w-button',['bind:__l',31,'bindtap',1,'data-event-opts',2,'rotate',3,'text',4,'vueId',5],[],e,s,gg)
_(t1O,c8O)
var h9O=_n('view')
_rz(z,h9O,'class',37,e,s,gg)
var o0O=_mz(z,'text',['bindtap',38,'class',1,'data-event-opts',2],[],e,s,gg)
var cAP=_oz(z,41,e,s,gg)
_(o0O,cAP)
_(h9O,o0O)
var oBP=_mz(z,'navigator',['url',-1,'openType',42],[],e,s,gg)
...
var eFP=_mz(z,'topic-item',['bind:__l',1,'vueId',1],[],e,s,gg)
_(tEP,eFP)
var bGP=_mz(z,'topic-item',['bind:__l',3,'vueId',1],[],e,s,gg)
_(tEP,bGP)
var oHP=_mz(z,'topic-item',['bind:__l',5,'vueId',1],[],e,s,gg)
_(tEP,oHP)
var xIP=_mz(z,'topic-item',['bind:__l',7,'vueId',1],[],e,s,gg)
_(tEP,xIP)
var oJP=_mz(z,'topic-item',['bind:__l',9,'vueId',1],[],e,s,gg)
_(tEP,oJP)
var fKP=_mz(z,'topic-item',['bind:__l',11,'vueId',1],[],e,s,gg)
_(tEP,fKP)
_(r,tEP)
return r
}
...
var oDM=_mz(z,'topic-item',['bind:__l',1,'vueId',1],[],e,s,gg)
_(bCM,oDM)
var xEM=_mz(z,'topic-item',['bind:__l',3,'vueId',1],[],e,s,gg)
_(bCM,xEM)
var oFM=_mz(z,'topic-item',['bind:__l',5,'vueId',1],[],e,s,gg)
_(bCM,oFM)
var fGM=_mz(z,'topic-item',['bind:__l',7,'vueId',1],[],e,s,gg)
_(bCM,fGM)
var cHM=_mz(z,'topic-item',['bind:__l',9,'vueId',1],[],e,s,gg)
_(bCM,cHM)
var hIM=_mz(z,'topic-item',['bind:__l',11,'vueId',1],[],e,s,gg)
_(bCM,hIM)
_(r,bCM)
return r
}
...
var xSM=_mz(z,'view',['bindtap',5,'class',1,'data-event-opts',2],[],tOM,aNM,gg)
var oTM=_n('view')
_rz(z,oTM,'class',8,tOM,aNM,gg)
var fUM=_mz(z,'image',['mode',9,'src',1],[],tOM,aNM,gg)
_(oTM,fUM)
_(xSM,oTM)
var cVM=_n('view')
_rz(z,cVM,'class',11,tOM,aNM,gg)
var hWM=_n('view')
_rz(z,hWM,'class',12,tOM,aNM,gg)
var oXM=_oz(z,13,tOM,aNM,gg)
_(hWM,oXM)
<<<<<<< HEAD
_(cVM,hWM)
_(xSM,cVM)
...
oLM.wxXCkey=2
_2z(z,2,lMM,e,s,gg,oLM,'item','index','index')
_(r,cKM)
=======
_(oRM,hWM)
var cYM=_n('view')
...
var a2M=_mz(z,'image',['mode',-1,'src',2],[],e,s,gg)
_(l1M,a2M)
_(oZM,l1M)
var t3M=_n('view')
...
<<<<<<< HEAD
var e8P=_n('view')
var b9P=_mz(z,'scroll-view',['scrollX',-1,'class',0],[],e,s,gg)
var o0P=_n('view')
...
var fCQ=_mz(z,'navigator',['class',4,'hoverClass',1,'url',2],[],e,s,gg)
var cDQ=_n('view')
...
_(fCQ,cDQ)
_(oBQ,fCQ)
var oFQ=_mz(z,'navigator',['class',9,'hoverClass',1,'url',2],[],e,s,gg)
var cGQ=_n('view')
...
_(b9P,oBQ)
_(e8P,b9P)
var lIQ=_mz(z,'my-login',['bind:__l',14,'vueId',1],[],e,s,gg)
_(e8P,lIQ)
_(r,e8P)
=======
var cCN=_n('view')
_rz(z,cCN,'class',0,e,s,gg)
var oDN=_mz(z,'form',['bindreset',1,'bindsubmit',1,'data-event-opts',2],[],e,s,gg)
var lEN=_n('view')
_rz(z,lEN,'class',4,e,s,gg)
var aFN=_mz(z,'textarea',['bindinput',5,'data-event-opts',1,'disabled',2,'maxlength',3,'placeholder',4],[],e,s,gg)
_(lEN,aFN)
_(oDN,lEN)
var tGN=_mz(z,'button',['class',10,'formType',1],[],e,s,gg)
...
var eLQ=_mz(z,'form',['bindreset',1,'bindsubmit',1,'data-event-opts',2],[],e,s,gg)
var bMQ=_n('view')
_rz(z,bMQ,'class',4,e,s,gg)
var oNQ=_mz(z,'textarea',['bindinput',5,'data-event-opts',1,'disabled',2,'maxlength',3,'placeholder',4],[],e,s,gg)
_(bMQ,oNQ)
_(eLQ,bMQ)
var xOQ=_mz(z,'button',['class',10,'formType',1],[],e,s,gg)
var oPQ=_oz(z,12,e,s,gg)
_(xOQ,oPQ)
_(eLQ,xOQ)
_(tKQ,eLQ)
_(r,tKQ)
...
var oLN=_mz(z,'form',['bindreset',1,'bindsubmit',1,'data-event-opts',2],[],e,s,gg)
var fMN=_n('view')
_rz(z,fMN,'class',4,e,s,gg)
var cNN=_mz(z,'textarea',['bindinput',5,'data-event-opts',1,'disabled',2,'maxlength',3,'placeholder',4],[],e,s,gg)
_(fMN,cNN)
_(oLN,fMN)
var hON=_mz(z,'button',['class',10,'formType',1],[],e,s,gg)
...
var eVN=_n('navigator')
_rz(z,eVN,'url',12,e,s,gg)
var bWN=_n('view')
...
var e0N=_n('navigator')
_rz(z,e0N,'url',18,e,s,gg)
var bAO=_n('view')
...
var o0Q=_n('navigator')
_rz(z,o0Q,'url',18,e,s,gg)
var lAR=_n('view')
...
var z=gz$gwx_32()
var cIO=_n('view')
var oJO=_mz(z,'my-login',['bind:__l',0,'vueId',1],[],e,s,gg)
_(cIO,oJO)
_(r,cIO)
return r
}
...
var z=gz$gwx_32()
var fIR=_n('view')
var hKR=_mz(z,'scroll-view',['scrollX',-1,'class',0],[],e,s,gg)
var oLR=_n('view')
...
var lOR=_mz(z,'navigator',['class',4,'hoverClass',1,'url',2],[],e,s,gg)
var aPR=_n('view')
...
_(lOR,aPR)
_(oNR,lOR)
var eRR=_mz(z,'navigator',['class',9,'hoverClass',1,'url',2],[],e,s,gg)
var bSR=_n('view')
...
var xUR=_mz(z,'my-login',['bind:__l',15,'vueId',1],[],e,s,gg)
_(cJR,xUR)
}
else{cJR.wxVkey=2
var oVR=_mz(z,'my-info',['bind:__l',17,'vueId',1],[],e,s,gg)
_(cJR,oVR)
}
cJR.wxXCkey=1
cJR.wxXCkey=3
...
=======
var bAO=_n('view')
var oBO=_mz(z,'my-login',['bind:__l',0,'vueId',1],[],e,s,gg)
_(bAO,oBO)
_(r,bAO)
return r
}
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:5735:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:5735:1)",{path:"./app.wxss"});    
__wxAppCode__['app.wxml']=$gwx('./app.wxml');

<<<<<<< HEAD
__wxAppCode__['components/ClassifyItem.wxss']=setCssToHead([".",[1],"classifyitem .",[1],"addwh { width: ",[0,330],"; height: ",[0,290],"; border-radius: ",[0,15],"; margin-bottom: ",[0,34],"; }\n.",[1],"classifyitem .",[1],"text-alignss{ width: 100% !important; text-align: center; color: #fdfeff; font-size: ",[0,34],"; }\n",],undefined,{path:"./components/ClassifyItem.wxss"});    
=======
__wxAppCode__['components/ClassifyItem.wxss']=setCssToHead([".",[1],"classifyitem .",[1],"cli { width: ",[0,330],"; height: ",[0,290],"; border-radius: ",[0,15],"; margin-bottom: ",[0,34],"; }\n.",[1],"bg-mask .",[1],"text-white{ width: 100%; text-align: center; color: #fdfeff; font-size: ",[0,34],"; }\n",],undefined,{path:"./components/ClassifyItem.wxss"});    
>>>>>>> master
__wxAppCode__['components/ClassifyItem.wxml']=$gwx('./components/ClassifyItem.wxml');

__wxAppCode__['components/CommentItem.wxss']=setCssToHead([".",[1],"head-img { width: ",[0,74],"; height: ",[0,74],"; }\n.",[1],"cu-list.",[1],"menu-avatar\x3e.",[1],"cu-item .",[1],"content\x3ewx-uni-view:first-child{ color:#424348; font-size: ",[0,20],"; }\n.",[1],"date-text { color: #878283; font-size: ",[0,20],"; }\n.",[1],"comment-bgc { background-color:#fff; }\n.",[1],"reapet-box { border:1px solid #8b8687; color:#404146; }\n.",[1],"text-co{ color:#404146; }\n",],undefined,{path:"./components/CommentItem.wxss"});    
__wxAppCode__['components/CommentItem.wxml']=$gwx('./components/CommentItem.wxml');

<<<<<<< HEAD
__wxAppCode__['components/DaySign.wxss']=setCssToHead(["@charset \x22UTF-8\x22;\n.",[1],"daysign { -webkit-box-shadow: rgba(26, 26, 26, 0.2) 0px 0px 5px 2px; box-shadow: rgba(26, 26, 26, 0.2) 0px 0px 5px 2px; text-shadow: 3px 2px 4px  #6a898e; margin: 0 ",[0,35],"; height: ",[0,500],"; font-family: \x27\\6977\\4F53\x27; position: relative; }\n.",[1],"daysign wx-image { width: 100%; height: 100%; z-index: 1; position: absolute; top: 0; left: 0; }\n.",[1],"daysign .",[1],"ds_day { padding: ",[0,50]," 0 0 ",[0,35],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"ds_day wx-text { font-size: ",[0,85],"; color: white; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"ds_day .",[1],"ds_day_time { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; margin-left: ",[0,25],"; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"ds_day .",[1],"fz-24 { font-size: ",[0,28],"; color: white; margin-bottom: ",[0,10],"; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"ds_title { margin-top: ",[0,50],"; font-size: ",[0,24],"; color: white; line-height: ",[0,40],"; margin-left: ",[0,35],"; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"author { font-size: ",[0,18],"; color: white; position: absolute; right: ",[0,50],"; bottom: ",[0,20],"; z-index: 2; }\n",],undefined,{path:"./components/DaySign.wxss"});    
__wxAppCode__['components/DaySign.wxml']=$gwx('./components/DaySign.wxml');

__wxAppCode__['components/DetailAuthor.wxss']=setCssToHead([".",[1],"author{ padding: ",[0,30],"; }\n.",[1],"title{ font-size: ",[0,48],"; color: #000; font-weight: 700; font-family: \x22\\5B8B\\4F53\x22; margin: ",[0,50]," 0; }\n.",[1],"cu-item { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; }\n.",[1],"head-img { margin-right: ",[0,20],"; width: ",[0,70],"; height: ",[0,70],"; }\n.",[1],"content { font-size: ",[0,22],"; }\n.",[1],"a-img { width: 100%; text-align: center; border-bottom: 1px solid #eaeaea; }\n.",[1],"a-img wx-image { margin-top: ",[0,130],"; width: ",[0,325],"; height: ",[0,325],"; vertical-align: middle; margin-bottom: ",[0,1],"; }\n.",[1],"a-dis { margin-top: ",[0,60],"; color: #a3a3a3; font-size: ",[0,24],"; line-height: ",[0,30],"; }\n.",[1],"notice { position: absolute; right: ",[0,30],"; line-height: ",[0,30],"; padding: ",[0,6],"; border: 1px solid #1e1e1e; border-radius: ",[0,21],"; }\n",],undefined,{path:"./components/DetailAuthor.wxss"});    
=======
__wxAppCode__['components/DaySign.wxss']=setCssToHead(["@charset \x22UTF-8\x22;\n.",[1],"daysign { text-shadow: 3px 2px 4px  #6a898e; margin: 0 ",[0,35],"; height: ",[0,500],"; font-family: \x27\\6977\\4F53\x27; position: relative; margin-bottom: ",[0,30],"; }\n.",[1],"daysign wx-image { width: 100%; height: 100%; z-index: 1; position: absolute; top: 0; left: 0; }\n.",[1],"daysign .",[1],"ds_day { padding: ",[0,50]," 0 0 ",[0,35],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"ds_day wx-text { font-size: ",[0,85],"; color: white; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"ds_day .",[1],"ds_day_time { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; margin-left: ",[0,25],"; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"ds_day .",[1],"fz-24 { font-size: ",[0,28],"; color: white; margin-bottom: ",[0,10],"; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"ds_title { margin-top: ",[0,50],"; font-size: ",[0,24],"; color: white; line-height: ",[0,40],"; margin-left: ",[0,35],"; position: relative; z-index: 2; }\n.",[1],"daysign .",[1],"author { font-size: ",[0,18],"; color: white; position: absolute; right: ",[0,50],"; bottom: ",[0,20],"; z-index: 2; }\n",],undefined,{path:"./components/DaySign.wxss"});    
__wxAppCode__['components/DaySign.wxml']=$gwx('./components/DaySign.wxml');

__wxAppCode__['components/DetailAuthor.wxss']=setCssToHead([".",[1],"author{ padding: ",[0,30],"; }\n.",[1],"title{ font-size: ",[0,48],"; color: #000; font-weight: 700; font-family: \x22\\5B8B\\4F53\x22; margin: ",[0,50]," 0; }\n.",[1],"cu-item { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; }\n.",[1],"head-img { margin-right: ",[0,20],"; width: ",[0,70],"; height: ",[0,70],"; }\n.",[1],"content { font-size: ",[0,22],"; }\n.",[1],"a-img { width: 100%; text-align: center; border-bottom: 1px solid #eaeaea; }\n.",[1],"a-img wx-image { margin-top: ",[0,130],"; width: ",[0,325],"; height: ",[0,325],"; vertical-align: middle; margin-bottom: ",[0,1],"; }\n.",[1],"a-dis { margin-top: ",[0,60],"; color: #a3a3a3; font-size: ",[0,24],"; line-height: ",[0,30],"; }\n.",[1],"notice { position: absolute; right: ",[0,30],"; line-height: ",[0,30],"; padding: ",[0,6],"; border: 1px solid #1e1e1e; border-radius: ",[0,21],"; }\n.",[1],"noticecheck { position: absolute; right: ",[0,30],"; line-height: ",[0,30],"; padding: ",[0,6],"; border: 1px solid #1e1e1e; border-radius: ",[0,21],"; color: gray; background: #1e1e1e; }\n",],undefined,{path:"./components/DetailAuthor.wxss"});    
>>>>>>> master
__wxAppCode__['components/DetailAuthor.wxml']=$gwx('./components/DetailAuthor.wxml');

__wxAppCode__['components/DetailFooter.wxss']=setCssToHead([".",[1],"detailfooter{ padding: ",[0,46]," ",[0,30],"; }\n.",[1],"df-text { border-top:1px solid #f2f2f2; }\n.",[1],"df-text1{ font-size: ",[0,20],"; line-height: ",[0,30],"; color: #b1b1b1; padding: ",[0,40]," 0; }\n.",[1],"look-num { margin-left: ",[0,12],"; color: #8b8687; }\n.",[1],"look-attentionfill { color:#8b8687; }\n",],undefined,{path:"./components/DetailFooter.wxss"});    
__wxAppCode__['components/DetailFooter.wxml']=$gwx('./components/DetailFooter.wxml');

__wxAppCode__['components/ExproreDetail.wxss']=undefined;    
__wxAppCode__['components/ExproreDetail.wxml']=$gwx('./components/ExproreDetail.wxml');

<<<<<<< HEAD
__wxAppCode__['components/ExproreText.wxss']=setCssToHead([".",[1],"exproretext{ padding: 0 ",[0,30],"; position: relative; z-index: 2; }\n.",[1],"_h1 { font-size: ",[0,38],"; color: #1a1a1a; text-align: center; }\n.",[1],"exproretext .",[1],"_p:nth-of-type(1){ font-size: ",[0,28],"; color: #a2a2a2; text-align: center; }\n.",[1],"exproretext .",[1],"_span,.",[1],"_p { font-size: ",[0,30],"; color: #232323; line-height: ",[0,40],"; text-align: justify; }\n.",[1],"exproretext .",[1],"_img { }\n",],undefined,{path:"./components/ExproreText.wxss"});    
__wxAppCode__['components/ExproreText.wxml']=$gwx('./components/ExproreText.wxml');

__wxAppCode__['components/Logins.wxss']=setCssToHead([".",[1],"my-nav{ position: relative; top:var(--status-bar-height); background-color:transparent; font-weight: 900; font-size: ",[0,50],"; }\n.",[1],"login-content{ display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; padding-top: ",[0,200],"; }\n.",[1],"My-login wx-image{ width: ",[0,140],"; height: ",[0,130],"; }\n.",[1],"login-title{ font-size: ",[0,32],"; letter-spacing: ",[0,5],"; margin-top: ",[0,100],"; margin-bottom: ",[0,85],"; color: #2f2f2f; font-size: ",[0,32],"; font-weight: 700; }\n.",[1],"login-btn{ background: #404146; color: white; width: ",[0,250],"; }\n.",[1],"btn-addpd{ padding: ",[0,10]," ",[0,20],"; }\n.",[1],"my-btns{ width: ",[0,300],"; height: ",[0,80],"; }\n",],undefined,{path:"./components/Logins.wxss"});    
__wxAppCode__['components/Logins.wxml']=$gwx('./components/Logins.wxml');

__wxAppCode__['components/MyInfo.wxss']=setCssToHead(["@charset \x22UTF-8\x22;\n.",[1],"my_imgbg { position: relative; }\n.",[1],"my_imgbg wx-image { width: 100%; height: ",[0,570],"; }\n.",[1],"my_imgbg .",[1],"usertitle { position: absolute; top: 30%; left: ",[0,32],"; }\n.",[1],"my_imgbg .",[1],"usertitle .",[1],"user-icon .",[1],"user-name { font-size: ",[0,32],"; font-weight: 600; color: white; margin-left: ",[0,40],"; }\n.",[1],"my_imgbg .",[1],"usertitle .",[1],"user-icon wx-image { width: ",[0,140],"; height: ",[0,140],"; border-radius: 50%; }\n.",[1],"my_imgbg .",[1],"usertitle .",[1],"user-weite { color: white; }\n.",[1],"my_imgbg .",[1],"usertitle .",[1],"user-weite .",[1],"my_wr { font-size: ",[0,24],"; }\n.",[1],"my_imgbg .",[1],"usertitle .",[1],"user-weite .",[1],"my_wr_icon { margin-left: ",[0,10],"; }\n.",[1],"my_imgbg .",[1],"howread { position: absolute; bottom: ",[0,40],"; left: ",[0,32],"; }\nwx-button .",[1],"cu-tag { position: absolute; top: ",[0,8],"; right: ",[0,8],"; }\n.",[1],"action wx-button { width: 100% !important; }\n",],undefined,{path:"./components/MyInfo.wxss"});    
__wxAppCode__['components/MyInfo.wxml']=$gwx('./components/MyInfo.wxml');
=======
__wxAppCode__['components/ExproreText.wxss']=setCssToHead([".",[1],"exproretext{ padding: 0 ",[0,30],"; position: relative; z-index: 2; }\n.",[1],"_h1 { font-size: ",[0,38],"; color: #1a1a1a; text-align: center; }\n.",[1],"exproretext .",[1],"_p:nth-of-type(1){ font-size: ",[0,28],"; color: #a2a2a2; text-align: center; }\n.",[1],"exproretext .",[1],"_span,.",[1],"_p { font-size: ",[0,30],"; color: #232323; line-height: ",[0,40],"; text-align: justify; }\n.",[1],"exproretext .",[1],"_img { margin: ",[0,20]," 0; }\n",],undefined,{path:"./components/ExproreText.wxss"});    
__wxAppCode__['components/ExproreText.wxml']=$gwx('./components/ExproreText.wxml');

__wxAppCode__['components/Foucse.wxss']=setCssToHead([".",[1],"foucse{ display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"fc-content{ display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"nownotice{ padding: ",[0,20]," ",[0,30],"; font-size: ",[0,22],"; font-weight: 500; color: #fff; background: #404146; border-radius: ",[0,10],"; }\n.",[1],"head-img1{ width: ",[0,125],"; height: ",[0,125],"; border-radius: 50%; border: 1px sollid #353535; }\n.",[1],"a-name1{ margin-left: ",[0,32],"; font-size: ",[0,20],"; color: #404146; }\n",],undefined,{path:"./components/Foucse.wxss"});    
__wxAppCode__['components/Foucse.wxml']=$gwx('./components/Foucse.wxml');

__wxAppCode__['components/Logins.wxss']=setCssToHead([".",[1],"my-nav{ position: relative; top:var(--status-bar-height); background-color:transparent; color: white; font-weight: 900; font-size: ",[0,50],"; }\n.",[1],"login-content{ display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; padding-top: ",[0,200],"; }\n.",[1],"My-login wx-image{ width: ",[0,140],"; height: ",[0,130],"; }\n.",[1],"login-title{ font-size: ",[0,32],"; letter-spacing: ",[0,5],"; margin-top: ",[0,100],"; margin-bottom: ",[0,85],"; color: #2f2f2f; font-size: ",[0,32],"; font-weight: 700; }\n.",[1],"login-btn{ background: #404146; color: white; width: ",[0,250],"; }\n.",[1],"btn-addpd{ padding: ",[0,10]," ",[0,20],"; }\n",],undefined,{path:"./components/Logins.wxss"});    
__wxAppCode__['components/Logins.wxml']=$gwx('./components/Logins.wxml');
>>>>>>> master

__wxAppCode__['components/MyTopics.wxss']=setCssToHead([".",[1],"topic-topbar{ -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; }\n",],undefined,{path:"./components/MyTopics.wxss"});    
__wxAppCode__['components/MyTopics.wxml']=$gwx('./components/MyTopics.wxml');

__wxAppCode__['components/PostComment.wxss']=setCssToHead([".",[1],"postcommen{ z-index: 2; background-color: #fff; position: fixed; bottom: 0; left: 0; right: 0; border-top: 1px solid #e7e7e7; line-height: ",[0,98],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-justify-content: space-around; -ms-flex-pack: distribute; justify-content: space-around; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"inp-text { width: ",[0,486],"; height: ",[0,60],"; border: 1px solid #bcbcbc; border-radius: ",[0,30],"; padding-left: ",[0,30],"; }\n.",[1],"pla-style { font-size: ",[0,30],"; color: #b2b2b2; }\n.",[1],"po-icon { font-size: ",[0,46],"; color: #37393e; }\n",],undefined,{path:"./components/PostComment.wxss"});    
__wxAppCode__['components/PostComment.wxml']=$gwx('./components/PostComment.wxml');

__wxAppCode__['components/Potery.wxss']=setCssToHead([".",[1],"names{ -webkit-flex-wrap: nowrap; -ms-flex-wrap: nowrap; flex-wrap: nowrap; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; }\n.",[1],"my_pos{ position: absolute; top: ",[0,20],"; right: ",[0,20],"; }\n.",[1],"my_add_boder wx-image{ border-radius: ",[0,15],"; }\n",],undefined,{path:"./components/Potery.wxss"});    
__wxAppCode__['components/Potery.wxml']=$gwx('./components/Potery.wxml');

__wxAppCode__['components/TopicItem.wxss']=setCssToHead([".",[1],"classifyitem { margin-bottom: ",[0,30],"; }\n.",[1],"classifyitem \x3ewx-uni-view { width: ",[0,690],"; height: ",[0,380],"; border-radius: ",[0,10],"; }\n.",[1],"bg-mask .",[1],"title-text{ width: 100%; text-align: center; color: #fdfeff; font-size: ",[0,44],"; margin-bottom: ",[0,20],"; }\n.",[1],"dis-text { color: #fcfcfe; font-size: ",[0,24],"; text-align: center; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2; overflow: hidden; padding: 0 ",[0,60],"; }\n",],undefined,{path:"./components/TopicItem.wxss"});    
__wxAppCode__['components/TopicItem.wxml']=$gwx('./components/TopicItem.wxml');
<<<<<<< HEAD
=======

__wxAppCode__['components/watch-button.wxss']=setCssToHead(["@-webkit-keyframes cuIcon-spin { 0% { -webkit-transform: rotate(0); transform: rotate(0); }\n100% { -webkit-transform: rotate(359deg); transform: rotate(359deg); }\n}@keyframes cuIcon-spin { 0% { -webkit-transform: rotate(0); transform: rotate(0); }\n100% { -webkit-transform: rotate(359deg); transform: rotate(359deg); }\n}.",[1],"cuIconfont-spin { -webkit-animation: cuIcon-spin 2s infinite linear; animation: cuIcon-spin 2s infinite linear; display: inline-block; }\n.",[1],"cuIconfont-pulse { -webkit-animation: cuIcon-spin 1s infinite steps(8); animation: cuIcon-spin 1s infinite steps(8); display: inline-block; }\n.",[1],"cuIcon { font-family: \x22cuIcon\x22; font-size: inherit; font-style: normal; }\n@font-face { font-family: \x22cuIcon\x22; src: url(\x27//at.alicdn.com/t/font_533566_yfq2d9wdij.eot?t\x3d1545239985831\x27); src: url(\x27//at.alicdn.com/t/font_533566_yfq2d9wdij.eot?t\x3d1545239985831#iefix\x27) format(\x27embedded-opentype\x27),\n		/* IE6-IE8 */\n		url(\x27data:application/x-font-woff;charset\x3dutf-8;base64,\x27) format(\x27woff\x27),\n		url(\x27//at.alicdn.com/t/font_533566_yfq2d9wdij.ttf?t\x3d1545239985831\x27) format(\x27truetype\x27),\n		/* chrome, firefox, opera, Safari, Android, iOS 4.2+*/\n		url(\x27//at.alicdn.com/t/font_533566_yfq2d9wdij.svg?t\x3d1545239985831#cuIconfont\x27) format(\x27svg\x27); }\n.",[1],"cuIcon-appreciate:before { content: \x22\\E644\x22; }\n.",[1],"cuIcon-check:before { content: \x22\\E645\x22; }\n.",[1],"cuIcon-close:before { content: \x22\\E646\x22; }\n.",[1],"cuIcon-edit:before { content: \x22\\E649\x22; }\n.",[1],"cuIcon-emoji:before { content: \x22\\E64A\x22; }\n.",[1],"cuIcon-favorfill:before { content: \x22\\E64B\x22; }\n.",[1],"cuIcon-favor:before { content: \x22\\E64C\x22; }\n.",[1],"cuIcon-loading:before { content: \x22\\E64F\x22; }\n.",[1],"cuIcon-locationfill:before { content: \x22\\E650\x22; }\n.",[1],"cuIcon-location:before { content: \x22\\E651\x22; }\n.",[1],"cuIcon-phone:before { content: \x22\\E652\x22; }\n.",[1],"cuIcon-roundcheckfill:before { content: \x22\\E656\x22; }\n.",[1],"cuIcon-roundcheck:before { content: \x22\\E657\x22; }\n.",[1],"cuIcon-roundclosefill:before { content: \x22\\E658\x22; }\n.",[1],"cuIcon-roundclose:before { content: \x22\\E659\x22; }\n.",[1],"cuIcon-roundrightfill:before { content: \x22\\E65A\x22; }\n.",[1],"cuIcon-roundright:before { content: \x22\\E65B\x22; }\n.",[1],"cuIcon-search:before { content: \x22\\E65C\x22; }\n.",[1],"cuIcon-taxi:before { content: \x22\\E65D\x22; }\n.",[1],"cuIcon-timefill:before { content: \x22\\E65E\x22; }\n.",[1],"cuIcon-time:before { content: \x22\\E65F\x22; }\n.",[1],"cuIcon-unfold:before { content: \x22\\E661\x22; }\n.",[1],"cuIcon-warnfill:before { content: \x22\\E662\x22; }\n.",[1],"cuIcon-warn:before { content: \x22\\E663\x22; }\n.",[1],"cuIcon-camerafill:before { content: \x22\\E664\x22; }\n.",[1],"cuIcon-camera:before { content: \x22\\E665\x22; }\n.",[1],"cuIcon-commentfill:before { content: \x22\\E666\x22; }\n.",[1],"cuIcon-comment:before { content: \x22\\E667\x22; }\n.",[1],"cuIcon-likefill:before { content: \x22\\E668\x22; }\n.",[1],"cuIcon-like:before { content: \x22\\E669\x22; }\n.",[1],"cuIcon-notificationfill:before { content: \x22\\E66A\x22; }\n.",[1],"cuIcon-notification:before { content: \x22\\E66B\x22; }\n.",[1],"cuIcon-order:before { content: \x22\\E66C\x22; }\n.",[1],"cuIcon-samefill:before { content: \x22\\E66D\x22; }\n.",[1],"cuIcon-same:before { content: \x22\\E66E\x22; }\n.",[1],"cuIcon-deliver:before { content: \x22\\E671\x22; }\n.",[1],"cuIcon-evaluate:before { content: \x22\\E672\x22; }\n.",[1],"cuIcon-pay:before { content: \x22\\E673\x22; }\n.",[1],"cuIcon-send:before { content: \x22\\E675\x22; }\n.",[1],"cuIcon-shop:before { content: \x22\\E676\x22; }\n.",[1],"cuIcon-ticket:before { content: \x22\\E677\x22; }\n.",[1],"cuIcon-back:before { content: \x22\\E679\x22; }\n.",[1],"cuIcon-cascades:before { content: \x22\\E67C\x22; }\n.",[1],"cuIcon-discover:before { content: \x22\\E67E\x22; }\n.",[1],"cuIcon-list:before { content: \x22\\E682\x22; }\n.",[1],"cuIcon-more:before { content: \x22\\E684\x22; }\n.",[1],"cuIcon-scan:before { content: \x22\\E689\x22; }\n.",[1],"cuIcon-settings:before { content: \x22\\E68A\x22; }\n.",[1],"cuIcon-questionfill:before { content: \x22\\E690\x22; }\n.",[1],"cuIcon-question:before { content: \x22\\E691\x22; }\n.",[1],"cuIcon-shopfill:before { content: \x22\\E697\x22; }\n.",[1],"cuIcon-form:before { content: \x22\\E699\x22; }\n.",[1],"cuIcon-pic:before { content: \x22\\E69B\x22; }\n.",[1],"cuIcon-filter:before { content: \x22\\E69C\x22; }\n.",[1],"cuIcon-footprint:before { content: \x22\\E69D\x22; }\n.",[1],"cuIcon-top:before { content: \x22\\E69E\x22; }\n.",[1],"cuIcon-pulldown:before { content: \x22\\E69F\x22; }\n.",[1],"cuIcon-pullup:before { content: \x22\\E6A0\x22; }\n.",[1],"cuIcon-right:before { content: \x22\\E6A3\x22; }\n.",[1],"cuIcon-refresh:before { content: \x22\\E6A4\x22; }\n.",[1],"cuIcon-moreandroid:before { content: \x22\\E6A5\x22; }\n.",[1],"cuIcon-deletefill:before { content: \x22\\E6A6\x22; }\n.",[1],"cuIcon-refund:before { content: \x22\\E6AC\x22; }\n.",[1],"cuIcon-cart:before { content: \x22\\E6AF\x22; }\n.",[1],"cuIcon-qrcode:before { content: \x22\\E6B0\x22; }\n.",[1],"cuIcon-remind:before { content: \x22\\E6B2\x22; }\n.",[1],"cuIcon-delete:before { content: \x22\\E6B4\x22; }\n.",[1],"cuIcon-profile:before { content: \x22\\E6B7\x22; }\n.",[1],"cuIcon-home:before { content: \x22\\E6B8\x22; }\n.",[1],"cuIcon-cartfill:before { content: \x22\\E6B9\x22; }\n.",[1],"cuIcon-discoverfill:before { content: \x22\\E6BA\x22; }\n.",[1],"cuIcon-homefill:before { content: \x22\\E6BB\x22; }\n.",[1],"cuIcon-message:before { content: \x22\\E6BC\x22; }\n.",[1],"cuIcon-addressbook:before { content: \x22\\E6BD\x22; }\n.",[1],"cuIcon-link:before { content: \x22\\E6BF\x22; }\n.",[1],"cuIcon-lock:before { content: \x22\\E6C0\x22; }\n.",[1],"cuIcon-unlock:before { content: \x22\\E6C2\x22; }\n.",[1],"cuIcon-vip:before { content: \x22\\E6C3\x22; }\n.",[1],"cuIcon-weibo:before { content: \x22\\E6C4\x22; }\n.",[1],"cuIcon-activity:before { content: \x22\\E6C5\x22; }\n.",[1],"cuIcon-friendaddfill:before { content: \x22\\E6C9\x22; }\n.",[1],"cuIcon-friendadd:before { content: \x22\\E6CA\x22; }\n.",[1],"cuIcon-friendfamous:before { content: \x22\\E6CB\x22; }\n.",[1],"cuIcon-friend:before { content: \x22\\E6CC\x22; }\n.",[1],"cuIcon-goods:before { content: \x22\\E6CD\x22; }\n.",[1],"cuIcon-selection:before { content: \x22\\E6CE\x22; }\n.",[1],"cuIcon-explore:before { content: \x22\\E6D2\x22; }\n.",[1],"cuIcon-present:before { content: \x22\\E6D3\x22; }\n.",[1],"cuIcon-squarecheckfill:before { content: \x22\\E6D4\x22; }\n.",[1],"cuIcon-square:before { content: \x22\\E6D5\x22; }\n.",[1],"cuIcon-squarecheck:before { content: \x22\\E6D6\x22; }\n.",[1],"cuIcon-round:before { content: \x22\\E6D7\x22; }\n.",[1],"cuIcon-roundaddfill:before { content: \x22\\E6D8\x22; }\n.",[1],"cuIcon-roundadd:before { content: \x22\\E6D9\x22; }\n.",[1],"cuIcon-add:before { content: \x22\\E6DA\x22; }\n.",[1],"cuIcon-notificationforbidfill:before { content: \x22\\E6DB\x22; }\n.",[1],"cuIcon-explorefill:before { content: \x22\\E6DD\x22; }\n.",[1],"cuIcon-fold:before { content: \x22\\E6DE\x22; }\n.",[1],"cuIcon-game:before { content: \x22\\E6DF\x22; }\n.",[1],"cuIcon-redpacket:before { content: \x22\\E6E0\x22; }\n.",[1],"cuIcon-selectionfill:before { content: \x22\\E6E1\x22; }\n.",[1],"cuIcon-similar:before { content: \x22\\E6E2\x22; }\n.",[1],"cuIcon-appreciatefill:before { content: \x22\\E6E3\x22; }\n.",[1],"cuIcon-infofill:before { content: \x22\\E6E4\x22; }\n.",[1],"cuIcon-info:before { content: \x22\\E6E5\x22; }\n.",[1],"cuIcon-forwardfill:before { content: \x22\\E6EA\x22; }\n.",[1],"cuIcon-forward:before { content: \x22\\E6EB\x22; }\n.",[1],"cuIcon-rechargefill:before { content: \x22\\E6EC\x22; }\n.",[1],"cuIcon-recharge:before { content: \x22\\E6ED\x22; }\n.",[1],"cuIcon-vipcard:before { content: \x22\\E6EE\x22; }\n.",[1],"cuIcon-voice:before { content: \x22\\E6EF\x22; }\n.",[1],"cuIcon-voicefill:before { content: \x22\\E6F0\x22; }\n.",[1],"cuIcon-friendfavor:before { content: \x22\\E6F1\x22; }\n.",[1],"cuIcon-wifi:before { content: \x22\\E6F2\x22; }\n.",[1],"cuIcon-share:before { content: \x22\\E6F3\x22; }\n.",[1],"cuIcon-wefill:before { content: \x22\\E6F4\x22; }\n.",[1],"cuIcon-we:before { content: \x22\\E6F5\x22; }\n.",[1],"cuIcon-lightauto:before { content: \x22\\E6F6\x22; }\n.",[1],"cuIcon-lightforbid:before { content: \x22\\E6F7\x22; }\n.",[1],"cuIcon-lightfill:before { content: \x22\\E6F8\x22; }\n.",[1],"cuIcon-camerarotate:before { content: \x22\\E6F9\x22; }\n.",[1],"cuIcon-light:before { content: \x22\\E6FA\x22; }\n.",[1],"cuIcon-barcode:before { content: \x22\\E6FB\x22; }\n.",[1],"cuIcon-flashlightclose:before { content: \x22\\E6FC\x22; }\n.",[1],"cuIcon-flashlightopen:before { content: \x22\\E6FD\x22; }\n.",[1],"cuIcon-searchlist:before { content: \x22\\E6FE\x22; }\n.",[1],"cuIcon-service:before { content: \x22\\E6FF\x22; }\n.",[1],"cuIcon-sort:before { content: \x22\\E700\x22; }\n.",[1],"cuIcon-down:before { content: \x22\\E703\x22; }\n.",[1],"cuIcon-mobile:before { content: \x22\\E704\x22; }\n.",[1],"cuIcon-mobilefill:before { content: \x22\\E705\x22; }\n.",[1],"cuIcon-copy:before { content: \x22\\E706\x22; }\n.",[1],"cuIcon-countdownfill:before { content: \x22\\E707\x22; }\n.",[1],"cuIcon-countdown:before { content: \x22\\E708\x22; }\n.",[1],"cuIcon-noticefill:before { content: \x22\\E709\x22; }\n.",[1],"cuIcon-notice:before { content: \x22\\E70A\x22; }\n.",[1],"cuIcon-upstagefill:before { content: \x22\\E70E\x22; }\n.",[1],"cuIcon-upstage:before { content: \x22\\E70F\x22; }\n.",[1],"cuIcon-babyfill:before { content: \x22\\E710\x22; }\n.",[1],"cuIcon-baby:before { content: \x22\\E711\x22; }\n.",[1],"cuIcon-brandfill:before { content: \x22\\E712\x22; }\n.",[1],"cuIcon-brand:before { content: \x22\\E713\x22; }\n.",[1],"cuIcon-choicenessfill:before { content: \x22\\E714\x22; }\n.",[1],"cuIcon-choiceness:before { content: \x22\\E715\x22; }\n.",[1],"cuIcon-clothesfill:before { content: \x22\\E716\x22; }\n.",[1],"cuIcon-clothes:before { content: \x22\\E717\x22; }\n.",[1],"cuIcon-creativefill:before { content: \x22\\E718\x22; }\n.",[1],"cuIcon-creative:before { content: \x22\\E719\x22; }\n.",[1],"cuIcon-female:before { content: \x22\\E71A\x22; }\n.",[1],"cuIcon-keyboard:before { content: \x22\\E71B\x22; }\n.",[1],"cuIcon-male:before { content: \x22\\E71C\x22; }\n.",[1],"cuIcon-newfill:before { content: \x22\\E71D\x22; }\n.",[1],"cuIcon-new:before { content: \x22\\E71E\x22; }\n.",[1],"cuIcon-pullleft:before { content: \x22\\E71F\x22; }\n.",[1],"cuIcon-pullright:before { content: \x22\\E720\x22; }\n.",[1],"cuIcon-rankfill:before { content: \x22\\E721\x22; }\n.",[1],"cuIcon-rank:before { content: \x22\\E722\x22; }\n.",[1],"cuIcon-bad:before { content: \x22\\E723\x22; }\n.",[1],"cuIcon-cameraadd:before { content: \x22\\E724\x22; }\n.",[1],"cuIcon-focus:before { content: \x22\\E725\x22; }\n.",[1],"cuIcon-friendfill:before { content: \x22\\E726\x22; }\n.",[1],"cuIcon-cameraaddfill:before { content: \x22\\E727\x22; }\n.",[1],"cuIcon-apps:before { content: \x22\\E729\x22; }\n.",[1],"cuIcon-paintfill:before { content: \x22\\E72A\x22; }\n.",[1],"cuIcon-paint:before { content: \x22\\E72B\x22; }\n.",[1],"cuIcon-picfill:before { content: \x22\\E72C\x22; }\n.",[1],"cuIcon-refresharrow:before { content: \x22\\E72D\x22; }\n.",[1],"cuIcon-colorlens:before { content: \x22\\E6E6\x22; }\n.",[1],"cuIcon-markfill:before { content: \x22\\E730\x22; }\n.",[1],"cuIcon-mark:before { content: \x22\\E731\x22; }\n.",[1],"cuIcon-presentfill:before { content: \x22\\E732\x22; }\n.",[1],"cuIcon-repeal:before { content: \x22\\E733\x22; }\n.",[1],"cuIcon-album:before { content: \x22\\E734\x22; }\n.",[1],"cuIcon-peoplefill:before { content: \x22\\E735\x22; }\n.",[1],"cuIcon-people:before { content: \x22\\E736\x22; }\n.",[1],"cuIcon-servicefill:before { content: \x22\\E737\x22; }\n.",[1],"cuIcon-repair:before { content: \x22\\E738\x22; }\n.",[1],"cuIcon-file:before { content: \x22\\E739\x22; }\n.",[1],"cuIcon-repairfill:before { content: \x22\\E73A\x22; }\n.",[1],"cuIcon-taoxiaopu:before { content: \x22\\E73B\x22; }\n.",[1],"cuIcon-weixin:before { content: \x22\\E612\x22; }\n.",[1],"cuIcon-attentionfill:before { content: \x22\\E73C\x22; }\n.",[1],"cuIcon-attention:before { content: \x22\\E73D\x22; }\n.",[1],"cuIcon-commandfill:before { content: \x22\\E73E\x22; }\n.",[1],"cuIcon-command:before { content: \x22\\E73F\x22; }\n.",[1],"cuIcon-communityfill:before { content: \x22\\E740\x22; }\n.",[1],"cuIcon-community:before { content: \x22\\E741\x22; }\n.",[1],"cuIcon-read:before { content: \x22\\E742\x22; }\n.",[1],"cuIcon-calendar:before { content: \x22\\E74A\x22; }\n.",[1],"cuIcon-cut:before { content: \x22\\E74B\x22; }\n.",[1],"cuIcon-magic:before { content: \x22\\E74C\x22; }\n.",[1],"cuIcon-backwardfill:before { content: \x22\\E74D\x22; }\n.",[1],"cuIcon-playfill:before { content: \x22\\E74F\x22; }\n.",[1],"cuIcon-stop:before { content: \x22\\E750\x22; }\n.",[1],"cuIcon-tagfill:before { content: \x22\\E751\x22; }\n.",[1],"cuIcon-tag:before { content: \x22\\E752\x22; }\n.",[1],"cuIcon-group:before { content: \x22\\E753\x22; }\n.",[1],"cuIcon-all:before { content: \x22\\E755\x22; }\n.",[1],"cuIcon-backdelete:before { content: \x22\\E756\x22; }\n.",[1],"cuIcon-hotfill:before { content: \x22\\E757\x22; }\n.",[1],"cuIcon-hot:before { content: \x22\\E758\x22; }\n.",[1],"cuIcon-post:before { content: \x22\\E759\x22; }\n.",[1],"cuIcon-radiobox:before { content: \x22\\E75B\x22; }\n.",[1],"cuIcon-rounddown:before { content: \x22\\E75C\x22; }\n.",[1],"cuIcon-upload:before { content: \x22\\E75D\x22; }\n.",[1],"cuIcon-writefill:before { content: \x22\\E760\x22; }\n.",[1],"cuIcon-write:before { content: \x22\\E761\x22; }\n.",[1],"cuIcon-radioboxfill:before { content: \x22\\E763\x22; }\n.",[1],"cuIcon-punch:before { content: \x22\\E764\x22; }\n.",[1],"cuIcon-shake:before { content: \x22\\E765\x22; }\n.",[1],"cuIcon-move:before { content: \x22\\E768\x22; }\n.",[1],"cuIcon-safe:before { content: \x22\\E769\x22; }\n.",[1],"cuIcon-activityfill:before { content: \x22\\E775\x22; }\n.",[1],"cuIcon-crownfill:before { content: \x22\\E776\x22; }\n.",[1],"cuIcon-crown:before { content: \x22\\E777\x22; }\n.",[1],"cuIcon-goodsfill:before { content: \x22\\E778\x22; }\n.",[1],"cuIcon-messagefill:before { content: \x22\\E779\x22; }\n.",[1],"cuIcon-profilefill:before { content: \x22\\E77A\x22; }\n.",[1],"cuIcon-sound:before { content: \x22\\E77B\x22; }\n.",[1],"cuIcon-sponsorfill:before { content: \x22\\E77C\x22; }\n.",[1],"cuIcon-sponsor:before { content: \x22\\E77D\x22; }\n.",[1],"cuIcon-upblock:before { content: \x22\\E77E\x22; }\n.",[1],"cuIcon-weblock:before { content: \x22\\E77F\x22; }\n.",[1],"cuIcon-weunblock:before { content: \x22\\E780\x22; }\n.",[1],"cuIcon-my:before { content: \x22\\E78B\x22; }\n.",[1],"cuIcon-myfill:before { content: \x22\\E78C\x22; }\n.",[1],"cuIcon-emojifill:before { content: \x22\\E78D\x22; }\n.",[1],"cuIcon-emojiflashfill:before { content: \x22\\E78E\x22; }\n.",[1],"cuIcon-flashbuyfill:before { content: \x22\\E78F\x22; }\n.",[1],"cuIcon-text:before { content: \x22\\E791\x22; }\n.",[1],"cuIcon-goodsfavor:before { content: \x22\\E794\x22; }\n.",[1],"cuIcon-musicfill:before { content: \x22\\E795\x22; }\n.",[1],"cuIcon-musicforbidfill:before { content: \x22\\E796\x22; }\n.",[1],"cuIcon-card:before { content: \x22\\E624\x22; }\n.",[1],"cuIcon-triangledownfill:before { content: \x22\\E79B\x22; }\n.",[1],"cuIcon-triangleupfill:before { content: \x22\\E79C\x22; }\n.",[1],"cuIcon-roundleftfill-copy:before { content: \x22\\E79E\x22; }\n.",[1],"cuIcon-font:before { content: \x22\\E76A\x22; }\n.",[1],"cuIcon-title:before { content: \x22\\E82F\x22; }\n.",[1],"cuIcon-recordfill:before { content: \x22\\E7A4\x22; }\n.",[1],"cuIcon-record:before { content: \x22\\E7A6\x22; }\n.",[1],"cuIcon-cardboardfill:before { content: \x22\\E7A9\x22; }\n.",[1],"cuIcon-cardboard:before { content: \x22\\E7AA\x22; }\n.",[1],"cuIcon-formfill:before { content: \x22\\E7AB\x22; }\n.",[1],"cuIcon-coin:before { content: \x22\\E7AC\x22; }\n.",[1],"cuIcon-cardboardforbid:before { content: \x22\\E7AF\x22; }\n.",[1],"cuIcon-circlefill:before { content: \x22\\E7B0\x22; }\n.",[1],"cuIcon-circle:before { content: \x22\\E7B1\x22; }\n.",[1],"cuIcon-attentionforbid:before { content: \x22\\E7B2\x22; }\n.",[1],"cuIcon-attentionforbidfill:before { content: \x22\\E7B3\x22; }\n.",[1],"cuIcon-attentionfavorfill:before { content: \x22\\E7B4\x22; }\n.",[1],"cuIcon-attentionfavor:before { content: \x22\\E7B5\x22; }\n.",[1],"cuIcon-titles:before { content: \x22\\E701\x22; }\n.",[1],"cuIcon-icloading:before { content: \x22\\E67A\x22; }\n.",[1],"cuIcon-full:before { content: \x22\\E7BC\x22; }\n.",[1],"cuIcon-mail:before { content: \x22\\E7BD\x22; }\n.",[1],"cuIcon-peoplelist:before { content: \x22\\E7BE\x22; }\n.",[1],"cuIcon-goodsnewfill:before { content: \x22\\E7BF\x22; }\n.",[1],"cuIcon-goodsnew:before { content: \x22\\E7C0\x22; }\n.",[1],"cuIcon-medalfill:before { content: \x22\\E7C1\x22; }\n.",[1],"cuIcon-medal:before { content: \x22\\E7C2\x22; }\n.",[1],"cuIcon-newsfill:before { content: \x22\\E7C3\x22; }\n.",[1],"cuIcon-newshotfill:before { content: \x22\\E7C4\x22; }\n.",[1],"cuIcon-newshot:before { content: \x22\\E7C5\x22; }\n.",[1],"cuIcon-news:before { content: \x22\\E7C6\x22; }\n.",[1],"cuIcon-videofill:before { content: \x22\\E7C7\x22; }\n.",[1],"cuIcon-video:before { content: \x22\\E7C8\x22; }\n.",[1],"cuIcon-exit:before { content: \x22\\E7CB\x22; }\n.",[1],"cuIcon-skinfill:before { content: \x22\\E7CC\x22; }\n.",[1],"cuIcon-skin:before { content: \x22\\E7CD\x22; }\n.",[1],"cuIcon-moneybagfill:before { content: \x22\\E7CE\x22; }\n.",[1],"cuIcon-usefullfill:before { content: \x22\\E7CF\x22; }\n.",[1],"cuIcon-usefull:before { content: \x22\\E7D0\x22; }\n.",[1],"cuIcon-moneybag:before { content: \x22\\E7D1\x22; }\n.",[1],"cuIcon-redpacket_fill:before { content: \x22\\E7D3\x22; }\n.",[1],"cuIcon-subscription:before { content: \x22\\E7D4\x22; }\n.",[1],"cuIcon-loading1:before { content: \x22\\E633\x22; }\n.",[1],"cuIcon-github:before { content: \x22\\E692\x22; }\n.",[1],"cuIcon-global:before { content: \x22\\E7EB\x22; }\n.",[1],"cuIcon-settingsfill:before { content: \x22\\E6AB\x22; }\n.",[1],"cuIcon-back_android:before { content: \x22\\E7ED\x22; }\n.",[1],"cuIcon-expressman:before { content: \x22\\E7EF\x22; }\n.",[1],"cuIcon-evaluate_fill:before { content: \x22\\E7F0\x22; }\n.",[1],"cuIcon-group_fill:before { content: \x22\\E7F5\x22; }\n.",[1],"cuIcon-play_forward_fill:before { content: \x22\\E7F6\x22; }\n.",[1],"cuIcon-deliver_fill:before { content: \x22\\E7F7\x22; }\n.",[1],"cuIcon-notice_forbid_fill:before { content: \x22\\E7F8\x22; }\n.",[1],"cuIcon-fork:before { content: \x22\\E60C\x22; }\n.",[1],"cuIcon-pick:before { content: \x22\\E7FA\x22; }\n.",[1],"cuIcon-wenzi:before { content: \x22\\E6A7\x22; }\n.",[1],"cuIcon-ellipse:before { content: \x22\\E600\x22; }\n.",[1],"cuIcon-qr_code:before { content: \x22\\E61B\x22; }\n.",[1],"cuIcon-dianhua:before { content: \x22\\E64D\x22; }\n.",[1],"cuIcon-cuIcon:before { content: \x22\\E602\x22; }\n.",[1],"cuIcon-loading2:before { content: \x22\\E7F1\x22; }\n.",[1],"cuIcon-btn:before { content: \x22\\E601\x22; }\n.",[1],"dlbutton { color: #FFFFFF; font-size: ",[0,30],"; width:",[0,601],"; height:",[0,100],"; background:-webkit-gradient(linear, left top, right top, from(rgba(0,0,0,0.7)), to(rgba(0,0,0,0.6))); background:-o-linear-gradient(left, rgba(0,0,0,0.7), rgba(0,0,0,0.6)); background:linear-gradient(to right, rgba(0,0,0,0.7), rgba(0,0,0,0.6)); -webkit-box-shadow:",[0,0]," ",[0,0]," ",[0,13]," ",[0,0]," rgba(164,217,228,0.4); box-shadow:",[0,0]," ",[0,0]," ",[0,13]," ",[0,0]," rgba(164,217,228,0.4); border-radius:2.5rem; line-height: ",[0,100],"; text-align: center; margin-left: auto; margin-right: auto; margin-top: ",[0,96],"; }\n.",[1],"dlbutton_loading { color: #FFFFFF; font-size: ",[0,30],"; width:",[0,100],"; height:",[0,100],"; background:-webkit-gradient(linear, left top, right top, from(rgba(0,0,0,0.7)), to(rgba(0,0,0,0.6))); background:-o-linear-gradient(left, rgba(0,0,0,0.7), rgba(0,0,0,0.6)); background:linear-gradient(to right, rgba(0,0,0,0.7), rgba(0,0,0,0.6)); -webkit-box-shadow:",[0,0]," ",[0,0]," ",[0,13]," ",[0,0]," rgba(164,217,228,0.4); box-shadow:",[0,0]," ",[0,0]," ",[0,13]," ",[0,0]," rgba(164,217,228,0.4); border-radius:2.5rem; line-height: ",[0,100],"; text-align: center; margin-left: auto; margin-right: auto; margin-top: ",[0,96],"; }\n.",[1],"buttonBorder{ border: none ; border-radius: 2.5rem ; -webkit-box-shadow: 0 0 ",[0,60]," 0 rgba(0,0,0,.2); box-shadow: 0 0 ",[0,60]," 0 rgba(0,0,0,.2); -webkit-transition: all 0.4s cubic-bezier(.57,.19,.51,.95); -o-transition: all 0.4s cubic-bezier(.57,.19,.51,.95); transition: all 0.4s cubic-bezier(.57,.19,.51,.95); }\n.",[1],"rotate_loop{ -webkit-transition-property: -webkit-transform; -webkit-transition-duration: 1s; -moz-transition-property: -moz-transform; -moz-transition-duration: 1s; -webkit-animation: rotate 1s linear infinite; animation: rotate 1s linear infinite; }\n@-webkit-keyframes rotate{from{-webkit-transform: rotate(0deg)}\nto{-webkit-transform: rotate(360deg)}\n}@keyframes rotate{from{-webkit-transform: rotate(0deg);transform: rotate(0deg)}\nto{-webkit-transform: rotate(359deg);transform: rotate(359deg)}\n}",],undefined,{path:"./components/watch-button.wxss"});    
__wxAppCode__['components/watch-button.wxml']=$gwx('./components/watch-button.wxml');

__wxAppCode__['components/watch-input.wxss']=setCssToHead(["@-webkit-keyframes cuIcon-spin { 0% { -webkit-transform: rotate(0); transform: rotate(0); }\n100% { -webkit-transform: rotate(359deg); transform: rotate(359deg); }\n}@keyframes cuIcon-spin { 0% { -webkit-transform: rotate(0); transform: rotate(0); }\n100% { -webkit-transform: rotate(359deg); transform: rotate(359deg); }\n}.",[1],"cuIconfont-spin { -webkit-animation: cuIcon-spin 2s infinite linear; animation: cuIcon-spin 2s infinite linear; display: inline-block; }\n.",[1],"cuIconfont-pulse { -webkit-animation: cuIcon-spin 1s infinite steps(8); animation: cuIcon-spin 1s infinite steps(8); display: inline-block; }\n.",[1],"cuIcon { font-family: \x22cuIcon\x22; font-size: inherit; font-style: normal; }\n@font-face { font-family: \x22cuIcon\x22; src: url(\x27//at.alicdn.com/t/font_533566_yfq2d9wdij.eot?t\x3d1545239985831\x27); src: url(\x27//at.alicdn.com/t/font_533566_yfq2d9wdij.eot?t\x3d1545239985831#iefix\x27) format(\x27embedded-opentype\x27),\n		/* IE6-IE8 */\n		url(\x27data:application/x-font-woff;charset\x3dutf-8;base64,\x27) format(\x27woff\x27),\n		url(\x27//at.alicdn.com/t/font_533566_yfq2d9wdij.ttf?t\x3d1545239985831\x27) format(\x27truetype\x27),\n		/* chrome, firefox, opera, Safari, Android, iOS 4.2+*/\n		url(\x27//at.alicdn.com/t/font_533566_yfq2d9wdij.svg?t\x3d1545239985831#cuIconfont\x27) format(\x27svg\x27); }\n.",[1],"cuIcon-appreciate:before { content: \x22\\E644\x22; }\n.",[1],"cuIcon-check:before { content: \x22\\E645\x22; }\n.",[1],"cuIcon-close:before { content: \x22\\E646\x22; }\n.",[1],"cuIcon-edit:before { content: \x22\\E649\x22; }\n.",[1],"cuIcon-emoji:before { content: \x22\\E64A\x22; }\n.",[1],"cuIcon-favorfill:before { content: \x22\\E64B\x22; }\n.",[1],"cuIcon-favor:before { content: \x22\\E64C\x22; }\n.",[1],"cuIcon-loading:before { content: \x22\\E64F\x22; }\n.",[1],"cuIcon-locationfill:before { content: \x22\\E650\x22; }\n.",[1],"cuIcon-location:before { content: \x22\\E651\x22; }\n.",[1],"cuIcon-phone:before { content: \x22\\E652\x22; }\n.",[1],"cuIcon-roundcheckfill:before { content: \x22\\E656\x22; }\n.",[1],"cuIcon-roundcheck:before { content: \x22\\E657\x22; }\n.",[1],"cuIcon-roundclosefill:before { content: \x22\\E658\x22; }\n.",[1],"cuIcon-roundclose:before { content: \x22\\E659\x22; }\n.",[1],"cuIcon-roundrightfill:before { content: \x22\\E65A\x22; }\n.",[1],"cuIcon-roundright:before { content: \x22\\E65B\x22; }\n.",[1],"cuIcon-search:before { content: \x22\\E65C\x22; }\n.",[1],"cuIcon-taxi:before { content: \x22\\E65D\x22; }\n.",[1],"cuIcon-timefill:before { content: \x22\\E65E\x22; }\n.",[1],"cuIcon-time:before { content: \x22\\E65F\x22; }\n.",[1],"cuIcon-unfold:before { content: \x22\\E661\x22; }\n.",[1],"cuIcon-warnfill:before { content: \x22\\E662\x22; }\n.",[1],"cuIcon-warn:before { content: \x22\\E663\x22; }\n.",[1],"cuIcon-camerafill:before { content: \x22\\E664\x22; }\n.",[1],"cuIcon-camera:before { content: \x22\\E665\x22; }\n.",[1],"cuIcon-commentfill:before { content: \x22\\E666\x22; }\n.",[1],"cuIcon-comment:before { content: \x22\\E667\x22; }\n.",[1],"cuIcon-likefill:before { content: \x22\\E668\x22; }\n.",[1],"cuIcon-like:before { content: \x22\\E669\x22; }\n.",[1],"cuIcon-notificationfill:before { content: \x22\\E66A\x22; }\n.",[1],"cuIcon-notification:before { content: \x22\\E66B\x22; }\n.",[1],"cuIcon-order:before { content: \x22\\E66C\x22; }\n.",[1],"cuIcon-samefill:before { content: \x22\\E66D\x22; }\n.",[1],"cuIcon-same:before { content: \x22\\E66E\x22; }\n.",[1],"cuIcon-deliver:before { content: \x22\\E671\x22; }\n.",[1],"cuIcon-evaluate:before { content: \x22\\E672\x22; }\n.",[1],"cuIcon-pay:before { content: \x22\\E673\x22; }\n.",[1],"cuIcon-send:before { content: \x22\\E675\x22; }\n.",[1],"cuIcon-shop:before { content: \x22\\E676\x22; }\n.",[1],"cuIcon-ticket:before { content: \x22\\E677\x22; }\n.",[1],"cuIcon-back:before { content: \x22\\E679\x22; }\n.",[1],"cuIcon-cascades:before { content: \x22\\E67C\x22; }\n.",[1],"cuIcon-discover:before { content: \x22\\E67E\x22; }\n.",[1],"cuIcon-list:before { content: \x22\\E682\x22; }\n.",[1],"cuIcon-more:before { content: \x22\\E684\x22; }\n.",[1],"cuIcon-scan:before { content: \x22\\E689\x22; }\n.",[1],"cuIcon-settings:before { content: \x22\\E68A\x22; }\n.",[1],"cuIcon-questionfill:before { content: \x22\\E690\x22; }\n.",[1],"cuIcon-question:before { content: \x22\\E691\x22; }\n.",[1],"cuIcon-shopfill:before { content: \x22\\E697\x22; }\n.",[1],"cuIcon-form:before { content: \x22\\E699\x22; }\n.",[1],"cuIcon-pic:before { content: \x22\\E69B\x22; }\n.",[1],"cuIcon-filter:before { content: \x22\\E69C\x22; }\n.",[1],"cuIcon-footprint:before { content: \x22\\E69D\x22; }\n.",[1],"cuIcon-top:before { content: \x22\\E69E\x22; }\n.",[1],"cuIcon-pulldown:before { content: \x22\\E69F\x22; }\n.",[1],"cuIcon-pullup:before { content: \x22\\E6A0\x22; }\n.",[1],"cuIcon-right:before { content: \x22\\E6A3\x22; }\n.",[1],"cuIcon-refresh:before { content: \x22\\E6A4\x22; }\n.",[1],"cuIcon-moreandroid:before { content: \x22\\E6A5\x22; }\n.",[1],"cuIcon-deletefill:before { content: \x22\\E6A6\x22; }\n.",[1],"cuIcon-refund:before { content: \x22\\E6AC\x22; }\n.",[1],"cuIcon-cart:before { content: \x22\\E6AF\x22; }\n.",[1],"cuIcon-qrcode:before { content: \x22\\E6B0\x22; }\n.",[1],"cuIcon-remind:before { content: \x22\\E6B2\x22; }\n.",[1],"cuIcon-delete:before { content: \x22\\E6B4\x22; }\n.",[1],"cuIcon-profile:before { content: \x22\\E6B7\x22; }\n.",[1],"cuIcon-home:before { content: \x22\\E6B8\x22; }\n.",[1],"cuIcon-cartfill:before { content: \x22\\E6B9\x22; }\n.",[1],"cuIcon-discoverfill:before { content: \x22\\E6BA\x22; }\n.",[1],"cuIcon-homefill:before { content: \x22\\E6BB\x22; }\n.",[1],"cuIcon-message:before { content: \x22\\E6BC\x22; }\n.",[1],"cuIcon-addressbook:before { content: \x22\\E6BD\x22; }\n.",[1],"cuIcon-link:before { content: \x22\\E6BF\x22; }\n.",[1],"cuIcon-lock:before { content: \x22\\E6C0\x22; }\n.",[1],"cuIcon-unlock:before { content: \x22\\E6C2\x22; }\n.",[1],"cuIcon-vip:before { content: \x22\\E6C3\x22; }\n.",[1],"cuIcon-weibo:before { content: \x22\\E6C4\x22; }\n.",[1],"cuIcon-activity:before { content: \x22\\E6C5\x22; }\n.",[1],"cuIcon-friendaddfill:before { content: \x22\\E6C9\x22; }\n.",[1],"cuIcon-friendadd:before { content: \x22\\E6CA\x22; }\n.",[1],"cuIcon-friendfamous:before { content: \x22\\E6CB\x22; }\n.",[1],"cuIcon-friend:before { content: \x22\\E6CC\x22; }\n.",[1],"cuIcon-goods:before { content: \x22\\E6CD\x22; }\n.",[1],"cuIcon-selection:before { content: \x22\\E6CE\x22; }\n.",[1],"cuIcon-explore:before { content: \x22\\E6D2\x22; }\n.",[1],"cuIcon-present:before { content: \x22\\E6D3\x22; }\n.",[1],"cuIcon-squarecheckfill:before { content: \x22\\E6D4\x22; }\n.",[1],"cuIcon-square:before { content: \x22\\E6D5\x22; }\n.",[1],"cuIcon-squarecheck:before { content: \x22\\E6D6\x22; }\n.",[1],"cuIcon-round:before { content: \x22\\E6D7\x22; }\n.",[1],"cuIcon-roundaddfill:before { content: \x22\\E6D8\x22; }\n.",[1],"cuIcon-roundadd:before { content: \x22\\E6D9\x22; }\n.",[1],"cuIcon-add:before { content: \x22\\E6DA\x22; }\n.",[1],"cuIcon-notificationforbidfill:before { content: \x22\\E6DB\x22; }\n.",[1],"cuIcon-explorefill:before { content: \x22\\E6DD\x22; }\n.",[1],"cuIcon-fold:before { content: \x22\\E6DE\x22; }\n.",[1],"cuIcon-game:before { content: \x22\\E6DF\x22; }\n.",[1],"cuIcon-redpacket:before { content: \x22\\E6E0\x22; }\n.",[1],"cuIcon-selectionfill:before { content: \x22\\E6E1\x22; }\n.",[1],"cuIcon-similar:before { content: \x22\\E6E2\x22; }\n.",[1],"cuIcon-appreciatefill:before { content: \x22\\E6E3\x22; }\n.",[1],"cuIcon-infofill:before { content: \x22\\E6E4\x22; }\n.",[1],"cuIcon-info:before { content: \x22\\E6E5\x22; }\n.",[1],"cuIcon-forwardfill:before { content: \x22\\E6EA\x22; }\n.",[1],"cuIcon-forward:before { content: \x22\\E6EB\x22; }\n.",[1],"cuIcon-rechargefill:before { content: \x22\\E6EC\x22; }\n.",[1],"cuIcon-recharge:before { content: \x22\\E6ED\x22; }\n.",[1],"cuIcon-vipcard:before { content: \x22\\E6EE\x22; }\n.",[1],"cuIcon-voice:before { content: \x22\\E6EF\x22; }\n.",[1],"cuIcon-voicefill:before { content: \x22\\E6F0\x22; }\n.",[1],"cuIcon-friendfavor:before { content: \x22\\E6F1\x22; }\n.",[1],"cuIcon-wifi:before { content: \x22\\E6F2\x22; }\n.",[1],"cuIcon-share:before { content: \x22\\E6F3\x22; }\n.",[1],"cuIcon-wefill:before { content: \x22\\E6F4\x22; }\n.",[1],"cuIcon-we:before { content: \x22\\E6F5\x22; }\n.",[1],"cuIcon-lightauto:before { content: \x22\\E6F6\x22; }\n.",[1],"cuIcon-lightforbid:before { content: \x22\\E6F7\x22; }\n.",[1],"cuIcon-lightfill:before { content: \x22\\E6F8\x22; }\n.",[1],"cuIcon-camerarotate:before { content: \x22\\E6F9\x22; }\n.",[1],"cuIcon-light:before { content: \x22\\E6FA\x22; }\n.",[1],"cuIcon-barcode:before { content: \x22\\E6FB\x22; }\n.",[1],"cuIcon-flashlightclose:before { content: \x22\\E6FC\x22; }\n.",[1],"cuIcon-flashlightopen:before { content: \x22\\E6FD\x22; }\n.",[1],"cuIcon-searchlist:before { content: \x22\\E6FE\x22; }\n.",[1],"cuIcon-service:before { content: \x22\\E6FF\x22; }\n.",[1],"cuIcon-sort:before { content: \x22\\E700\x22; }\n.",[1],"cuIcon-down:before { content: \x22\\E703\x22; }\n.",[1],"cuIcon-mobile:before { content: \x22\\E704\x22; }\n.",[1],"cuIcon-mobilefill:before { content: \x22\\E705\x22; }\n.",[1],"cuIcon-copy:before { content: \x22\\E706\x22; }\n.",[1],"cuIcon-countdownfill:before { content: \x22\\E707\x22; }\n.",[1],"cuIcon-countdown:before { content: \x22\\E708\x22; }\n.",[1],"cuIcon-noticefill:before { content: \x22\\E709\x22; }\n.",[1],"cuIcon-notice:before { content: \x22\\E70A\x22; }\n.",[1],"cuIcon-upstagefill:before { content: \x22\\E70E\x22; }\n.",[1],"cuIcon-upstage:before { content: \x22\\E70F\x22; }\n.",[1],"cuIcon-babyfill:before { content: \x22\\E710\x22; }\n.",[1],"cuIcon-baby:before { content: \x22\\E711\x22; }\n.",[1],"cuIcon-brandfill:before { content: \x22\\E712\x22; }\n.",[1],"cuIcon-brand:before { content: \x22\\E713\x22; }\n.",[1],"cuIcon-choicenessfill:before { content: \x22\\E714\x22; }\n.",[1],"cuIcon-choiceness:before { content: \x22\\E715\x22; }\n.",[1],"cuIcon-clothesfill:before { content: \x22\\E716\x22; }\n.",[1],"cuIcon-clothes:before { content: \x22\\E717\x22; }\n.",[1],"cuIcon-creativefill:before { content: \x22\\E718\x22; }\n.",[1],"cuIcon-creative:before { content: \x22\\E719\x22; }\n.",[1],"cuIcon-female:before { content: \x22\\E71A\x22; }\n.",[1],"cuIcon-keyboard:before { content: \x22\\E71B\x22; }\n.",[1],"cuIcon-male:before { content: \x22\\E71C\x22; }\n.",[1],"cuIcon-newfill:before { content: \x22\\E71D\x22; }\n.",[1],"cuIcon-new:before { content: \x22\\E71E\x22; }\n.",[1],"cuIcon-pullleft:before { content: \x22\\E71F\x22; }\n.",[1],"cuIcon-pullright:before { content: \x22\\E720\x22; }\n.",[1],"cuIcon-rankfill:before { content: \x22\\E721\x22; }\n.",[1],"cuIcon-rank:before { content: \x22\\E722\x22; }\n.",[1],"cuIcon-bad:before { content: \x22\\E723\x22; }\n.",[1],"cuIcon-cameraadd:before { content: \x22\\E724\x22; }\n.",[1],"cuIcon-focus:before { content: \x22\\E725\x22; }\n.",[1],"cuIcon-friendfill:before { content: \x22\\E726\x22; }\n.",[1],"cuIcon-cameraaddfill:before { content: \x22\\E727\x22; }\n.",[1],"cuIcon-apps:before { content: \x22\\E729\x22; }\n.",[1],"cuIcon-paintfill:before { content: \x22\\E72A\x22; }\n.",[1],"cuIcon-paint:before { content: \x22\\E72B\x22; }\n.",[1],"cuIcon-picfill:before { content: \x22\\E72C\x22; }\n.",[1],"cuIcon-refresharrow:before { content: \x22\\E72D\x22; }\n.",[1],"cuIcon-colorlens:before { content: \x22\\E6E6\x22; }\n.",[1],"cuIcon-markfill:before { content: \x22\\E730\x22; }\n.",[1],"cuIcon-mark:before { content: \x22\\E731\x22; }\n.",[1],"cuIcon-presentfill:before { content: \x22\\E732\x22; }\n.",[1],"cuIcon-repeal:before { content: \x22\\E733\x22; }\n.",[1],"cuIcon-album:before { content: \x22\\E734\x22; }\n.",[1],"cuIcon-peoplefill:before { content: \x22\\E735\x22; }\n.",[1],"cuIcon-people:before { content: \x22\\E736\x22; }\n.",[1],"cuIcon-servicefill:before { content: \x22\\E737\x22; }\n.",[1],"cuIcon-repair:before { content: \x22\\E738\x22; }\n.",[1],"cuIcon-file:before { content: \x22\\E739\x22; }\n.",[1],"cuIcon-repairfill:before { content: \x22\\E73A\x22; }\n.",[1],"cuIcon-taoxiaopu:before { content: \x22\\E73B\x22; }\n.",[1],"cuIcon-weixin:before { content: \x22\\E612\x22; }\n.",[1],"cuIcon-attentionfill:before { content: \x22\\E73C\x22; }\n.",[1],"cuIcon-attention:before { content: \x22\\E73D\x22; }\n.",[1],"cuIcon-commandfill:before { content: \x22\\E73E\x22; }\n.",[1],"cuIcon-command:before { content: \x22\\E73F\x22; }\n.",[1],"cuIcon-communityfill:before { content: \x22\\E740\x22; }\n.",[1],"cuIcon-community:before { content: \x22\\E741\x22; }\n.",[1],"cuIcon-read:before { content: \x22\\E742\x22; }\n.",[1],"cuIcon-calendar:before { content: \x22\\E74A\x22; }\n.",[1],"cuIcon-cut:before { content: \x22\\E74B\x22; }\n.",[1],"cuIcon-magic:before { content: \x22\\E74C\x22; }\n.",[1],"cuIcon-backwardfill:before { content: \x22\\E74D\x22; }\n.",[1],"cuIcon-playfill:before { content: \x22\\E74F\x22; }\n.",[1],"cuIcon-stop:before { content: \x22\\E750\x22; }\n.",[1],"cuIcon-tagfill:before { content: \x22\\E751\x22; }\n.",[1],"cuIcon-tag:before { content: \x22\\E752\x22; }\n.",[1],"cuIcon-group:before { content: \x22\\E753\x22; }\n.",[1],"cuIcon-all:before { content: \x22\\E755\x22; }\n.",[1],"cuIcon-backdelete:before { content: \x22\\E756\x22; }\n.",[1],"cuIcon-hotfill:before { content: \x22\\E757\x22; }\n.",[1],"cuIcon-hot:before { content: \x22\\E758\x22; }\n.",[1],"cuIcon-post:before { content: \x22\\E759\x22; }\n.",[1],"cuIcon-radiobox:before { content: \x22\\E75B\x22; }\n.",[1],"cuIcon-rounddown:before { content: \x22\\E75C\x22; }\n.",[1],"cuIcon-upload:before { content: \x22\\E75D\x22; }\n.",[1],"cuIcon-writefill:before { content: \x22\\E760\x22; }\n.",[1],"cuIcon-write:before { content: \x22\\E761\x22; }\n.",[1],"cuIcon-radioboxfill:before { content: \x22\\E763\x22; }\n.",[1],"cuIcon-punch:before { content: \x22\\E764\x22; }\n.",[1],"cuIcon-shake:before { content: \x22\\E765\x22; }\n.",[1],"cuIcon-move:before { content: \x22\\E768\x22; }\n.",[1],"cuIcon-safe:before { content: \x22\\E769\x22; }\n.",[1],"cuIcon-activityfill:before { content: \x22\\E775\x22; }\n.",[1],"cuIcon-crownfill:before { content: \x22\\E776\x22; }\n.",[1],"cuIcon-crown:before { content: \x22\\E777\x22; }\n.",[1],"cuIcon-goodsfill:before { content: \x22\\E778\x22; }\n.",[1],"cuIcon-messagefill:before { content: \x22\\E779\x22; }\n.",[1],"cuIcon-profilefill:before { content: \x22\\E77A\x22; }\n.",[1],"cuIcon-sound:before { content: \x22\\E77B\x22; }\n.",[1],"cuIcon-sponsorfill:before { content: \x22\\E77C\x22; }\n.",[1],"cuIcon-sponsor:before { content: \x22\\E77D\x22; }\n.",[1],"cuIcon-upblock:before { content: \x22\\E77E\x22; }\n.",[1],"cuIcon-weblock:before { content: \x22\\E77F\x22; }\n.",[1],"cuIcon-weunblock:before { content: \x22\\E780\x22; }\n.",[1],"cuIcon-my:before { content: \x22\\E78B\x22; }\n.",[1],"cuIcon-myfill:before { content: \x22\\E78C\x22; }\n.",[1],"cuIcon-emojifill:before { content: \x22\\E78D\x22; }\n.",[1],"cuIcon-emojiflashfill:before { content: \x22\\E78E\x22; }\n.",[1],"cuIcon-flashbuyfill:before { content: \x22\\E78F\x22; }\n.",[1],"cuIcon-text:before { content: \x22\\E791\x22; }\n.",[1],"cuIcon-goodsfavor:before { content: \x22\\E794\x22; }\n.",[1],"cuIcon-musicfill:before { content: \x22\\E795\x22; }\n.",[1],"cuIcon-musicforbidfill:before { content: \x22\\E796\x22; }\n.",[1],"cuIcon-card:before { content: \x22\\E624\x22; }\n.",[1],"cuIcon-triangledownfill:before { content: \x22\\E79B\x22; }\n.",[1],"cuIcon-triangleupfill:before { content: \x22\\E79C\x22; }\n.",[1],"cuIcon-roundleftfill-copy:before { content: \x22\\E79E\x22; }\n.",[1],"cuIcon-font:before { content: \x22\\E76A\x22; }\n.",[1],"cuIcon-title:before { content: \x22\\E82F\x22; }\n.",[1],"cuIcon-recordfill:before { content: \x22\\E7A4\x22; }\n.",[1],"cuIcon-record:before { content: \x22\\E7A6\x22; }\n.",[1],"cuIcon-cardboardfill:before { content: \x22\\E7A9\x22; }\n.",[1],"cuIcon-cardboard:before { content: \x22\\E7AA\x22; }\n.",[1],"cuIcon-formfill:before { content: \x22\\E7AB\x22; }\n.",[1],"cuIcon-coin:before { content: \x22\\E7AC\x22; }\n.",[1],"cuIcon-cardboardforbid:before { content: \x22\\E7AF\x22; }\n.",[1],"cuIcon-circlefill:before { content: \x22\\E7B0\x22; }\n.",[1],"cuIcon-circle:before { content: \x22\\E7B1\x22; }\n.",[1],"cuIcon-attentionforbid:before { content: \x22\\E7B2\x22; }\n.",[1],"cuIcon-attentionforbidfill:before { content: \x22\\E7B3\x22; }\n.",[1],"cuIcon-attentionfavorfill:before { content: \x22\\E7B4\x22; }\n.",[1],"cuIcon-attentionfavor:before { content: \x22\\E7B5\x22; }\n.",[1],"cuIcon-titles:before { content: \x22\\E701\x22; }\n.",[1],"cuIcon-icloading:before { content: \x22\\E67A\x22; }\n.",[1],"cuIcon-full:before { content: \x22\\E7BC\x22; }\n.",[1],"cuIcon-mail:before { content: \x22\\E7BD\x22; }\n.",[1],"cuIcon-peoplelist:before { content: \x22\\E7BE\x22; }\n.",[1],"cuIcon-goodsnewfill:before { content: \x22\\E7BF\x22; }\n.",[1],"cuIcon-goodsnew:before { content: \x22\\E7C0\x22; }\n.",[1],"cuIcon-medalfill:before { content: \x22\\E7C1\x22; }\n.",[1],"cuIcon-medal:before { content: \x22\\E7C2\x22; }\n.",[1],"cuIcon-newsfill:before { content: \x22\\E7C3\x22; }\n.",[1],"cuIcon-newshotfill:before { content: \x22\\E7C4\x22; }\n.",[1],"cuIcon-newshot:before { content: \x22\\E7C5\x22; }\n.",[1],"cuIcon-news:before { content: \x22\\E7C6\x22; }\n.",[1],"cuIcon-videofill:before { content: \x22\\E7C7\x22; }\n.",[1],"cuIcon-video:before { content: \x22\\E7C8\x22; }\n.",[1],"cuIcon-exit:before { content: \x22\\E7CB\x22; }\n.",[1],"cuIcon-skinfill:before { content: \x22\\E7CC\x22; }\n.",[1],"cuIcon-skin:before { content: \x22\\E7CD\x22; }\n.",[1],"cuIcon-moneybagfill:before { content: \x22\\E7CE\x22; }\n.",[1],"cuIcon-usefullfill:before { content: \x22\\E7CF\x22; }\n.",[1],"cuIcon-usefull:before { content: \x22\\E7D0\x22; }\n.",[1],"cuIcon-moneybag:before { content: \x22\\E7D1\x22; }\n.",[1],"cuIcon-redpacket_fill:before { content: \x22\\E7D3\x22; }\n.",[1],"cuIcon-subscription:before { content: \x22\\E7D4\x22; }\n.",[1],"cuIcon-loading1:before { content: \x22\\E633\x22; }\n.",[1],"cuIcon-github:before { content: \x22\\E692\x22; }\n.",[1],"cuIcon-global:before { content: \x22\\E7EB\x22; }\n.",[1],"cuIcon-settingsfill:before { content: \x22\\E6AB\x22; }\n.",[1],"cuIcon-back_android:before { content: \x22\\E7ED\x22; }\n.",[1],"cuIcon-expressman:before { content: \x22\\E7EF\x22; }\n.",[1],"cuIcon-evaluate_fill:before { content: \x22\\E7F0\x22; }\n.",[1],"cuIcon-group_fill:before { content: \x22\\E7F5\x22; }\n.",[1],"cuIcon-play_forward_fill:before { content: \x22\\E7F6\x22; }\n.",[1],"cuIcon-deliver_fill:before { content: \x22\\E7F7\x22; }\n.",[1],"cuIcon-notice_forbid_fill:before { content: \x22\\E7F8\x22; }\n.",[1],"cuIcon-fork:before { content: \x22\\E60C\x22; }\n.",[1],"cuIcon-pick:before { content: \x22\\E7FA\x22; }\n.",[1],"cuIcon-wenzi:before { content: \x22\\E6A7\x22; }\n.",[1],"cuIcon-ellipse:before { content: \x22\\E600\x22; }\n.",[1],"cuIcon-qr_code:before { content: \x22\\E61B\x22; }\n.",[1],"cuIcon-dianhua:before { content: \x22\\E64D\x22; }\n.",[1],"cuIcon-cuIcon:before { content: \x22\\E602\x22; }\n.",[1],"cuIcon-loading2:before { content: \x22\\E7F1\x22; }\n.",[1],"cuIcon-btn:before { content: \x22\\E601\x22; }\n.",[1],"main-list{ display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; height: ",[0,36],"; color: #333333; padding: ",[0,32],"; margin-top:",[0,24],"; margin-bottom: ",[0,24],"; }\n.",[1],"img{ width: ",[0,32],"; height: ",[0,32],"; font-size: ",[0,32],"; }\n.",[1],"main-input{ -webkit-box-flex: 1; -webkit-flex: 1; -ms-flex: 1; flex: 1; text-align: left; font-size: ",[0,28],"; padding-right: ",[0,10],"; margin-left: ",[0,20],"; }\n.",[1],"vercode { color: rgba(0,0,0,0.7); font-size: ",[0,24],"; line-height: ",[0,100],"; }\n.",[1],"vercode-run { color: rgba(0,0,0,0.4) !important; }\n.",[1],"oBorder{ border: none; border-radius: 2.5rem ; -webkit-box-shadow: 0 0 ",[0,60]," 0 rgba(43,86,112,.1); box-shadow: 0 0 ",[0,60]," 0 rgba(43,86,112,.1); }\n",],undefined,{path:"./components/watch-input.wxss"});    
__wxAppCode__['components/watch-input.wxml']=$gwx('./components/watch-input.wxml');

__wxAppCode__['pages/clntest/clntest.wxss']=setCssToHead([".",[1],"clntest { padding-bottom: ",[0,80],"; }\n",],undefined,{path:"./pages/clntest/clntest.wxss"});    
__wxAppCode__['pages/clntest/clntest.wxml']=$gwx('./pages/clntest/clntest.wxml');
>>>>>>> master
...
__wxAppCode__['pages/moretopic/moretopic.wxss']=setCssToHead([".",[1],"moretopic{ display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n",],undefined,{path:"./pages/moretopic/moretopic.wxss"});    
__wxAppCode__['pages/moretopic/moretopic.wxml']=$gwx('./pages/moretopic/moretopic.wxml');

__wxAppCode__['pages/moretopic/mtopic.wxss']=setCssToHead([".",[1],"names{ -webkit-flex-wrap: nowrap; -ms-flex-wrap: nowrap; flex-wrap: nowrap; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; }\n.",[1],"my_pos{ position: absolute; top: ",[0,20],"; right: ",[0,20],"; }\n.",[1],"my_add_boder wx-image{ border-radius: ",[0,15],"; }\n",],undefined,{path:"./pages/moretopic/mtopic.wxss"});    
__wxAppCode__['pages/moretopic/mtopic.wxml']=$gwx('./pages/moretopic/mtopic.wxml');

__wxAppCode__['pages/my/Aboutus.wxss']=setCssToHead([".",[1],"mores{ text-align: center; }\n.",[1],"more-logo wx-image{ width: ",[0,100],"; height: ",[0,100],"; }\n.",[1],"banben{ }\n",],undefined,{path:"./pages/my/Aboutus.wxss"});    
__wxAppCode__['pages/my/Aboutus.wxml']=$gwx('./pages/my/Aboutus.wxml');

__wxAppCode__['pages/my/Goviews.wxss']=setCssToHead([".",[1],"my-nav{ position: relative; top:var(--status-bar-height); background-color:transparent; font-weight: 900; font-size: ",[0,50],"; }\n.",[1],"login-content{ display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; padding-top: ",[0,200],"; }\n.",[1],"My-login wx-image{ width: ",[0,140],"; height: ",[0,130],"; }\n.",[1],"login-title{ font-size: ",[0,32],"; letter-spacing: ",[0,5],"; margin-top: ",[0,100],"; margin-bottom: ",[0,85],"; color: #2f2f2f; font-size: ",[0,32],"; font-weight: 700; }\n.",[1],"login-btn{ background: #404146; color: white; width: ",[0,250],"; }\n.",[1],"btn-addpd{ padding: ",[0,10]," ",[0,20],"; }\n.",[1],"my-btns{ width: ",[0,300],"; height: ",[0,80],"; }\n",],undefined,{path:"./pages/my/Goviews.wxss"});    
__wxAppCode__['pages/my/Goviews.wxml']=$gwx('./pages/my/Goviews.wxml');

__wxAppCode__['pages/my/my.wxss']=setCssToHead([".",[1],"my-nav{ position: relative; top:var(--status-bar-height); background-color:transparent; font-weight: 900; font-size: ",[0,50],"; }\n.",[1],"login-content{ display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; padding-top: ",[0,200],"; }\n.",[1],"My-login wx-image{ width: ",[0,140],"; height: ",[0,130],"; }\n.",[1],"login-title{ font-size: ",[0,32],"; letter-spacing: ",[0,5],"; margin-top: ",[0,100],"; margin-bottom: ",[0,85],"; color: #2f2f2f; font-size: ",[0,32],"; font-weight: 700; }\n.",[1],"login-btn{ background: #404146; color: white; width: ",[0,250],"; }\n.",[1],"btn-addpd{ padding: ",[0,10]," ",[0,20],"; }\n.",[1],"my-btns{ width: ",[0,300],"; height: ",[0,80],"; }\n",],undefined,{path:"./pages/my/my.wxss"});    
__wxAppCode__['pages/my/my.wxml']=$gwx('./pages/my/my.wxml');

__wxAppCode__['pages/my/Sendemail.wxss']=setCssToHead([".",[1],"addmymargin{ margin: ",[0,50],"; }\n",],undefined,{path:"./pages/my/Sendemail.wxss"});    
__wxAppCode__['pages/my/Sendemail.wxml']=$gwx('./pages/my/Sendemail.wxml');

__wxAppCode__['pages/my/Setting.wxss']=undefined;    
__wxAppCode__['pages/my/Setting.wxml']=$gwx('./pages/my/Setting.wxml');

__wxAppCode__['pages/my/Userinfo.wxss']=setCssToHead([".",[1],"userinfocontent{ padding: 0 ",[0,20],"; letter-spacing: ",[0,5],"; font-size: ",[0,30],"; text-align: justify; }\n",],undefined,{path:"./pages/my/Userinfo.wxss"});    
