...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'bg-green nav text-center my-nav '])
Z([3,'cu-item fl'])
Z([3,'cuIcon-notice'])
Z([3,'fr'])
Z(z[3])
...
Z(z[5])
Z([3,'../login/login'])
Z([3,'cu-btn round lg  bg-black btn-addpd shadow'])
Z([3,'登录'])
...
Z(z[1])
Z([3,'__e'])
Z([[4],[[5],[[5],[1,'slidingMenuList']],[[2,'?:'],[[2,'=='],[[7],[3,'activeIndex']],[[7],[3,'index']]],[1,'active'],[1,'']]]])
